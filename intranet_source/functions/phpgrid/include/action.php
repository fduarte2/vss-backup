...
*/	
	...
	// edit, Adam Walter, May 2008.
	// the line below was causing numbers of slashes and quotes to be unnecessarily added.
	// I've changed the trim function from "trim(... "'")" to "trim(..."\\'")" to compensate.
	// also, this function is bogus, in that numeric values might still be in varchar
	// fields, so I'm canning the "if" statement
	$pk_val = "'".trim($pk_val, "\\'")."'"; // $pk_val = is_numeric($pk_val) ? $pk_val : "'".trim($pk_val, "\\'")."'";
