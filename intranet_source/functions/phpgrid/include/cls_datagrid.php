	...
	function render_body(){
		...
		while($cols = $this_db->fetch_array($rs_body)){
			...
			if($this->masterdetail_sql != ""){
							...
							// This function was NOT doing what I wanted it to do; in it's original form, it basically forced
							// The column name of the 2 joined tables to be the same, or else it returned nothing.
							// much as I hate editing pre-packaged source code, this commented-and-replace line below was necessary.

//				$master_foreign_id = $cols[$this->masterdetail_key];
				$master_foreign_id = $cols[$this->sql_key];
