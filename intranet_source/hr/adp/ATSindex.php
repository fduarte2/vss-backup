...
<table border="0" width="100%" cellpadding="4" cellspacing="0">
   <tr>
      ...
      <td>
	 <p align="left">
	    <font size="5" face="Verdana" color="#0066CC">Export ATS To ADP
	    </font>
	    <hr>
	 </p>
      </td>
...
<table border="0" width="100%" cellpadding="4" cellspacing="0"> 
   <tr>
	 ...
	 <p>
            <form action="ATS_to_ADP.php" method="post" name="adp_export">
	       Week of Monday: <input type="textbox" name="start_date" size=10 value="<? echo $last_mon; ?>"><a href="javascript:show_calendar('adp_export.start_date');" onmouseover="window.status='Date Picker';return true;" onmouseout="window.status='';return true;"><img src="/images/show-calendar.gif" width=24 height=22 border=0></a><br />
