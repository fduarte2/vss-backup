...
//     if((($sendMail || $i > 0) && ($DayOfWeek == 7 || $DayOfWeek == 1))){
	...
	if($i > 0)
        ...
        $pdf->ezSetDy(-5);
//        $pdf->ezText("<b>   Scanned: $count_scan</b>", 12, $left);
        $pdf->ezSetDy(-5);
...
//		$mailTO = "ithomas@port.state.de.us";
        	...
        	$mailheaders  = "From: " . "MailServer@port.state.de.us\r\n";
		$mailheaders .= "Cc: bboles@port.state.de.us, phemphill@port.state.de.us\r\n";
        	$mailheaders .= "Bcc: " . "hdadmin@port.state.de.us,rwang@port.state.de.us,mpallmann@port.state.de.us\r\n";
