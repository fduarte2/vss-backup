...
<form action="add_emp_ssn_process.php" enctype="multipart/form-data" method="post" name="upload">
...
<table border="0" width="100%" cellpadding="4" cellspacing="0">
   <tr>
      ...
      <td>
         <p align="left">
            <font size="5" face="Verdana" color="#0066CC">Add Employee and SSN By Uploading A File Containing Employee ID and SSN
            </font>
            <hr>
         </p>
...
<b><a href="emp_ssn_input_sample.php">-> An Input File Example <-</a></b><br><br>
