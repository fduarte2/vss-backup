<?
  ...
  $cursor = ora_open($conn);
   ...
   $sql = "select distinct a.EFF_DATE from employee_rate a order by a.EFF_DATE desc";
...
?>   
   ...
   <br><br>
   <form name="view_rate_list"  action="display_rate_list.php" method="post">
...
<?  } ?>
   ...
   <input type="submit" value="Display Employee Rate List">
   </form><br><hr><br>
  ...
  <?
  	...
  	if (strlen($sel_eff_date) > 1 )
  	{
  		...
  		$sql="select b.EMPLOYEE_ID, a.EMPLOYEE_NAME, b.PAY_RATE, TO_CHAR(b.EFF_DATE, 'mm/dd/yyyy')
					from employee a, employee_rate b
...
?>
	...
	<table border="1">
	<tr><th>Employee ID</th><th>Employee Name</th><th>Rate</th><th>Effective Date</th></tr>
...
<?
	      	...
	      	while (ora_fetch($cursor)){
   			...
   			$emp_rate = ora_getcolumn($cursor,2);
   			$eff_date = ora_getcolumn($cursor,3);
?>  		
  			<tr><td><?=$emp_id ?></td><td><?=$emp_name ?></td><td><?=$emp_rate ?></td><td><?=$eff_date ?></td></tr>
