...
*/
  ...
  if(! $type){
    echo "Type MUST be set for barcode!  Please contact Technology Solutions.";
    exit;
  }
  if(! $code){
    echo "Code is NULL- is there a value in the item which needs scanned?  Please contact Technology Solutions.";
    exit;
  }
