...
class Calendar {
    ...
    * @param none
    */
    function Calendar($isPopup = true, $month = null, $year = null, $weekstart = 0) {
          ...
          <tr>
            <td class="borderColor">
        	  <table border="0" cellspacing="1" cellpadding="0">
			  	<tr><td colspan="7" class="monthNameStyle"><?= $this->monthName . ' ' . $this->year ?></td></tr>
	...
	*/
	function printJumpForm() {
		?>
         <form id="changeMonth" name="changeMonth" action="<?= $_SERVER['PHP_SELF'] . '?' . $this->scheduleid ?>" method="post" style="margin-bottom: 0px;">
        ...
        ?>
        		<td style="width: 33%;" class="navMonthStyle"><a href="javascript: changeDate(<?= $prevMonth . "," . $prevYear?>);"><?= "&lt; " . date("M",mktime(0,0,0,$prevMonth,1,$prevYear))  ?></a></td>
        		<td style="width: 33%">
        ...
        for ($m = 1; $m < 13; $m++) {
            ...
            echo '>' . date('F',mktime(0,0,0,$m,1)) . "</option>\n";
        }
        ?>
        		  </select>
        		...
        		<td style="width: 33%;" class="navMonthStyle"><a href="javascript: changeDate(<?= $nextMonth . "," . $nextYear?>);"><?= date("M",mktime(0,0,0,$nextMonth,1,$nextYear)) . " &gt;" ?></a></td>
        	  </tr>
            </table>
          </form>
	<?
