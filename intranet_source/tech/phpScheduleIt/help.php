  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="5" style="border: solid #CCCCCC 1px">
    <tr> 
      <td bgcolor="#FAFAFA"> 
        ...
        <p>In order to use the use the scheduling system, you must first register. 
          ...
          in pages) you will see a welcome message, today's date, and 4 links 
          -- a &quot;Log Out&quot; link and a &quot;My Control Panel&quot; link
          underneath the welcome message, and &quot;Help Me&quot and &quot;Email
          Admin&quot; links under the date.</p>
        ...
        <p>If you do not have permission to use a resource, have questions about
          ...
          of each page, underneath the date.</p>
        ...
        <p>The Quick Links table will provide you with common application links. The first &quot;Go 
          to the Online Scheduler&quot; will take you to the Scheduler. Here you 
          can view resource schedules, reserve resources, and edit your current reservations.</p>
        <p>The second link, &quot;Change My Profile Information/Password &quot; will
          bring up navigate to a page allowing you to edit your personal information,
          such as login email 
        ...
        <p>The next link, &quot;Manage My Email Preferences&quot; will take you to a page
        ...
        <p>The next link, &quot;Report a Bug&quot; is a feature that will open a pop-up
          window and will allow you to report any bugs or problems you have while
          using the phpScheduleIt system. These reports will be sent to technical
          support and if a bug is discovered, it will be fixed in the next version
          of phpScheduleIt.</p>
        ...
        <p align="right"><a href="#top">Top</a></p>
        <h5><a name="making_a_reservation" id="making_a_reservation"></a>Read-Only
        Version</h5>
        ...
        <p>To reserve a resource, first navigate to the table for the day you
          ...
          the 
          requested day, click on the machine name. This will bring up a pop-up
        ...
        <p>You can add a summary of this reservation by filling out the summary
          ...
          read.</p>        <p>After setting correct beginning and ending times for the
        ...
        <h5><a name="modifying_deleting_a_reservation" id="modifying_deleting_a_reservation"></a>Modifying/Deleting 
          a Reservation</h5>
        <p>There are 2 ways to modify or delete a reservation. One is from <a href="#my_control_panel">My 
          Control Panel</a> as described above. The other is through the online 
          scheduler. As previously noted, only you will be able to modify your 
        ...
        &quot;Update all recurring reservations in group?&quot;. Any conflicting dates
          will be listed.</p>
        ...
        <p>There are 3 ways to navigate to dates in the scheduler.</p>
