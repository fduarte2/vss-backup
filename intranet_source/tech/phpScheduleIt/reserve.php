...
function process_reservation($fn) {
	...
	if ($fn == 'create')
		$res->add_res($_POST['machid'], $_SESSION['sessionID'], $_POST['startTime'], $_POST['endTime'], $repeat, $_POST['minRes'], $_POST['maxRes'], stripslashes($_POST['summary']), $_POST['scheduleid']);
	else if ($fn == 'modify')
		$res->mod_res($_POST['startTime'], $_POST['endTime'], isset($_POST['del']), $_POST['minRes'], $_POST['maxRes'], isset($_POST['mod_recur']), stripslashes($_POST['summary']));
	else if ($fn == 'delete')
