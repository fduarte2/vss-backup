...
function printLinks($prev, $next) {
    ...
    echo "<p align=\"center\">\n"
      . $link->getLink("javascript: viewUser('" . $prev . "');", "&laquo; Previous User") . "\n"
      . "&nbsp;&nbsp;&nbsp;"
      . $link->getLink("javascript: viewUser('" . $next . "');", "Next User &raquo;") . "\n"
      . "</p>\n"
      . "<p>&nbsp;</p>\n"
      . "<p align=\"center\"><input type=\"button\" name=\"close\" value=\"Close Window\" class=\"button\" onclick=\"window.close();\" />"
      . "</p>\n";
}
?>