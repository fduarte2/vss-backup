...
<table border="0" width="100%" cellpadding="4" cellspacing="0">
   <tr>
      ...
      <td>
	 <p align="left">
	    <font size="5" face="Verdana" color="#0066CC">Edit Claim
	    </font>
	    <hr>
	 </p>
      </td>
...
<?
  ...
  if($edit_claim_id != ""){
    echo "<b>Claim $edit_claim_id has been successfully edited!</b><br /><br />";
  }
?>
	 <p align="left">
	    <font size="2" face="Verdana"><b>Select or Free-Form Claim Number</b><br />
         <table width="95%" bgcolor="#f0f0f0" border="0" cellpadding="4" cellspacing="4">
            <tr>
               ...
               <form action="edit2.php" method="Post" name="claim_form">
            <tr>
...
//                        $stmt = "select distinct claim_id, customer_invoice_num, customer_id from claim_log where completed = 'f' or completed is null";
