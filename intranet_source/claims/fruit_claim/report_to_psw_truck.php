...
//get customer name
$cust = getRFSeasonCustomerList($cursor, $season, $cargo_type, "truck");

$total_submission = 0;
$total_pow_100_payment = 0;
$total_pow_100_denial = 0;
$total_powpsw_resp_amt = 0;
$total_powpsw_resp_qty = 0;
$total_acceptance = 0;
$total_68 = 0;
$total_cartons = 0;
...
<table border="0" width="100%" cellpadding="4" cellspacing="0">
	<tr>
		...
		<table border="2" width="100%" cellpadding="0" cellspacing="0">
			<tr bgcolor="F0F0F0">
				<td align="center"><font size="4" face="Verdana"><b><? echo $season; ?> POW Trucked In Fruit Claim Summary Report -- <? echo $cargo_type; ?></b></font></td>
			</tr>
		</table>
		</td>
	</tr>
...
<!--				<td align="center"><font size="3" face="Verdana"><b>POW Payment @ 100%</b></font></td> !-->
				<td align="center"><font size="3" face="Verdana"><b>POW Denials</b></font></td>
				<td align="center"><font size="3" face="Verdana"><b>Ship Line Qty</b></font></td> 
				<td align="center"><font size="3" face="Verdana"><b>Ship Line Amount</b></font></td> 
				<td align="center"><font size="3" face="Verdana"><b>POW Responsibility</b></font></td>
...
while(list($cust_id, $cust_name)=each($cust)){
	...
	$sql = "select customer_id, sum(claim_amt) as submission, sum(claim_qty) as CASES 
		...
		and b.status <> 'D' 
		and (vessel is null or vessel = 'TRUCK')
...
*/
	...
	$sql = "select customer_name, sum(port_amt) as sumport, sum(denied_amt) as sumdenied, sum(ship_line_amt) as sumslineamt, sum(SHIP_LINE_QTY) as sumslineqty 
...
//	echo $sql;
	...
	if(ora_fetch_into($cursor, $row, ORA_FETCHINTO_NULLS|ORA_FETCHINTO_ASSOC)){
		...
		$powpsw_resp_amt = $row['SUMSLINEAMT'];
		$powpsw_resp_qty = $row['SUMSLINEQTY'];
		$total_pow_100_payment += $pow_100_payment;
		$total_pow_100_denial += $pow_100_denial;
		$total_powpsw_resp_amt += $powpsw_resp_amt;
		$total_powpsw_resp_qty += $powpsw_resp_qty;
	} else {
		$pow_100_payment = "0";
		$pow_100_denial = "0";
		$powpsw_resp_amt = "0";
	...
	$acceptance = $submission - $pow_100_denial;
	$total_acceptance += $acceptance;

?>
			<tr>
				<td align="left"><font size="2" face="Verdana"><a href="report_detail_truck.php?type=<? echo $cargo_type; ?>&season=<? echo $season; ?>&customer=<? echo $cust_id; ?>&LR=truck"><? echo $customer_name; ?></a></font></td>
...
<!--				<td align="right"><font size="2" face="Verdana">$<? echo number_format($pow_100_payment,2,'.',','); ?></font></td> !-->
				...
				<td align="right"><font size="2" face="Verdana">$<? echo number_format($powpsw_resp_qty,2,'.',','); ?></font></td> 
				<td align="right"><font size="2" face="Verdana">$<? echo number_format($powpsw_resp_amt,2,'.',','); ?></font></td> 
...
<?
	...
	if($total_powpsw_resp_amt == "" || $total_powpsw_resp_amt == 0){
		$total_powpsw_resp_amt = "0";
	}
	if($total_powpsw_resp_qty == "" || $total_powpsw_resp_qty == 0){
		$total_powpsw_resp_qty = "0";
	}
...
<!--				<td align="right"><font size="2" face="Verdana"><b>$<? echo number_format($total_pow_100_payment,2,'.',','); ?></b></font></td> !-->
				...
				<td align="right"><font size="2" face="Verdana"><b>$<? echo number_format($total_powpsw_resp_amt,2,'.',','); ?></b></font></td> 
				<td align="right"><font size="2" face="Verdana"><b>$<? echo number_format($total_powpsw_resp_qty,2,'.',','); ?></b></font></td> 
...
<!--	<tr>
		...
		<table border="1" width="100%" cellpadding="1" cellspacing="0">
			<tr bgcolor="F0F0F0">
				<td colspan="2" align="center"><font size="3" face="Verdana"><b>POW Payments:</b></font></td>
			</tr>
			<tr>
