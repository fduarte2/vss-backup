...
*************************************************************************/
  ...
  $report_access = "daily_outbound_summary";
...
<table border="0" width="100%" cellpadding="4" cellspacing="0">
   <tr>
      ...
      <td>
	 <p align="left">
	    <font size="5" face="Verdana" color="#0066CC">Daily Outbound Activity Summary Report
</font>
	    <hr>
	 </p>
      </td>
...
<table border="0" width="100%" cellpadding="4" cellspacing="0">
<form name="get_data" action="daily_outbound_summary_pdf.php" method="post">
	<tr>
	...
	<tr>
		<td width="10%" align="left"><font size="2" face="Verdana">Wing:  </font></td>
		<td><select name="wing"><option value="All">All</option>
<?
	$sql = "SELECT DISTINCT WHS_ID FROM WAREHOUSE_LIST
			ORDER BY WHS_ID";
	$stid = ociparse($conn, $sql);
	ociexecute($stid);
	while(ocifetch($stid)){
?>
			<option value="<? echo ociresult($stid, "WHS_ID"); ?>"><? echo ociresult($stid, "WHS_ID"); ?></option>
<?
	}
?>
			</select></td>
