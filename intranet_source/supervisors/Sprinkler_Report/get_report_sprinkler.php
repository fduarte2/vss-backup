...
<table border="0" width="100%" cellpadding="4" cellspacing="0">
<?
	$sql = "SELECT TO_CHAR(START_SCAN, 'MM/DD/YYYY HH24:MI') THE_START, TO_CHAR(END_SCAN, 'MM/DD/YYYY HH24:MI') THE_END, DETAIL_FILE_NAME, 
				TO_CHAR(UPLOAD_TIME, 'MM/DD/YYYY HH24:MI') THE_UPLOAD, UPLOADED_BY, COMMENTS, SKIP_REASONS 
			FROM PIPESCAN_LOG_SPRINKLER 
			WHERE START_SCAN <= TO_DATE('".$time_in_question."', 'MM/DD/YYYY HH24') 
				AND END_SCAN >= TO_DATE('".$time_in_question."', 'MM/DD/YYYY HH24') 
