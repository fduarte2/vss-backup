...
<script type="text/javascript">
   ...
   {
	var answer = confirm ("Are you sure you want to refresh to current vessel discharge status?")
	if (answer)
	{
		document.report_form.action = "preprocess.php";
		document.report_form.submit();
	}
   }
	    ...
	    <tr>
	       ...
	       ?>
            ...
            <tr>
               <td colspan="2">&nbsp;</td>
               <td align="left">
			   	  <input type="button" name="refresh" value=" Refresh " onclick ="javascript:refresh_report()">&nbsp;&nbsp;&nbsp;&nbsp;
