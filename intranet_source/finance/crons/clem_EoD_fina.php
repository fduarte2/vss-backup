...
//		printf(ora_errorcode($conn));
	...
	$output = "<table>
				<tr>
					<td colspan=\"2\"><font size=\"3\" face=\"Verdana\">Daily Clementine Canadian inventory as of ".$the_date."</font></td>
					<td colspan=\"2\">&nbsp;</td>
				</tr>";
	...
	if(!ocifetch($stid)){
		...
		do {
			$output .= "<tr>
							<tdfont size=\"3\" face=\"Verdana\">Commodity ".ociresult($stid, "COMMODITY_CODE")."</font></td>
		...
		$output .= "<tr>
						<tdfont size=\"3\" face=\"Verdana\">Total Canadian Clementine Inventory <b>(A)</b>:</font></td>
						<td>".$total_plt."</td>
					</tr>";
		$output .= "<tr><td colspan=\"2\">&nbsp;</td></tr>";
