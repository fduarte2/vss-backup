...
*  A page to count all pallets in warehouse C3 (and A1)
...
<table border="0" width="100%" cellpadding="4" cellspacing="0">
   <tr>
      ...
      <td>
	 <p align="left">
	    <font size="5" face="Verdana" color="#0066CC">Warehouse C3/A1 Details
</font>
	    <hr>
	 </p>
      </td>
...
<table border="0" width="100%" cellpadding="4" cellspacing="0">
<form name="the_form" action="C3.php" method="post">
	<tr>
		<td width="1%">&nbsp;</td>
...
<?
	...
	$sql = "SELECT RBD.PALLET_ID PALLET_ID, 
				...
				FROM RF_BILLING_DETAIL RBD, (SELECT DISTINCT PALLET_ID, ARRIVAL_NUM, RECEIVER_ID
											...
											WHERE (WAREHOUSE_LOCATION LIKE 'C3%' OR WAREHOUSE_LOCATION LIKE 'A1%')
...
?>
	<tr>
		<td align="center"><font size="3" face="Verdana">No warehouse C3/A1 Billing Records for the given date range.  <a href="C3.php">Click Here</a> to return to the previous page.</font></td>
	</tr></table>
<?
	exit;
	}
?>
	<tr>
		<td align="center"><b><font size="4" face="Verdana">Invoiced Inventory for C3/A1, <? echo $dateStart; ?> -- <? echo $dateEnd; ?>:</b><BR></font></td>
	</tr>
	<tr>
		<td align="center">&nbsp;<BR><font size="2" face="Verdana">Note:  <b>Only</b> Invoiced inventory that has a warehouse location containing "C3/A1" will be reported here.<BR>&nbsp;<BR>&nbsp;<BR>&nbsp;<BR></font></td>
	</tr><? fwrite($handle, "Invoiced Inventory for C3/A1, ".$dateStart." -- ".$dateEnd."\n\n"); ?>
		 <? fwrite($handle, "Note:  Only Invoiced inventory that has a warehouse location containing \"C3/A1\" will be reported here.\n\n"); ?>
	<tr>
...
?>
	...
	<tr>
		<td align="center"><font size="2" face="Verdana"><BR><BR><a href="C3.php">Return to the previous page.</a></font></td>
	</tr>
</table>
<?
	fclose($handle);
