<?
   ...
   if ($bill_select != "") {
	 ...
	 exit;
      ...
      if ($page == "un-delete") {
	 $stmt = "select * from $rf_billing where billing_num = $bill_free and service_status = 'DELETED'";
      } else {
	 $stmt = "select * from $rf_billing where billing_num = $bill_free and service_status = 'PREINVOICE'";
      }
