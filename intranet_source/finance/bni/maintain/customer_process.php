...
//  $user = $userdata['username'];
  ...
  $claim_address = $HTTP_POST_VARS["claim_address"];
  $claim_address2 = $HTTP_POST_VARS["claim_address2"];
  $city = $HTTP_POST_VARS["city"];
  $state = $HTTP_POST_VARS["state"];
  $zip = $HTTP_POST_VARS["zip"];
  $claim_city = $HTTP_POST_VARS["claim_city"];
  $claim_state = $HTTP_POST_VARS["claim_state"];
  $claim_zip = $HTTP_POST_VARS["claim_zip"];
  ...
  $claim_address = OraSafeString($claim_address);
  $claim_address2 = OraSafeString($claim_address2);
  $city = OraSafeString($city);
  $state = OraSafeString($state);
  $email = OraSafeString($email);
  $claim_city = OraSafeString($claim_city);
  $claim_state = OraSafeString($claim_state);
 ...
 //Modify a customer
  ...
  //Update to BNI
    ...
    $sql = "update customer_profile set customer_name = '$customer_name',
			...
			customer_claim_address1 = '$claim_address', customer_claim_address2 = '$claim_address2',
			customer_claim_city = '$claim_city', customer_claim_state = '$claim_state', customer_claim_zip = '$claim_zip'
...
// Adding a customer
 ...
 //Delete a Customer
  ...
  $sql = "select * from vessel_completion_email where category = 'Bni_Customer'";
  $stmt = ora_parse($cursor,$sql);
...
if($claim_address != ""){
	$body .= "CLAIMS-address: $claim_address\n";
}
if($claim_address2 != ""){
	$body .= "CLAIMS-address2: $claim_address2\n";
}
if($claim_city != ""){
	$body .= "CLAIMS-city: $claim_city\n";
}
if($claim_state != ""){
	$body .= "CLAIMS-state: $claim_state\n";
}
if($claim_zip != ""){
	$body .= "CLAIMS-zip: $claim_zip\n";
}

  $body = $body . "\nPlease ensure that this is taken care of in the Oracle Financial System\n\nThanks!\n\nBNI Automated Integrity Check System";
...
header("Location: customer.php?added=$added&modify=$modify&delete=$delete");
