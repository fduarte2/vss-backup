...
//		printf(ora_errorcode($bniconn));
	...
	if($submit == "Process Checkboxes"){
		...
		echo "<font color=\"0000FF\">Bills Updated.  ".$updates." bill(s) marked DELETED</font></br>";
	}
...
<table border="0" width="100%" cellpadding="4" cellspacing="0">
   <tr>
      <td width="1%">&nbsp;</td>
      <td>
         <font size="5" face="Verdana" color="#0066CC">Delete (non-storage) V1 Pre-Invoices by Date</font>
...
<table border="0" width="100%" cellpadding="4" cellspacing="0"> 
<form name="meh" action="delete_date_range.php" method="post">
	<tr>
...
?>
<form name="save" action="delete_date_range.php" method="post">
