...
<table border="0" width="100%" cellpadding="4" cellspacing="0">
   <tr>
      <td width="1%">&nbsp;</td>
      <td>
         <font size="5" face="Verdana" color="#0066CC">Update V2 Invoices</font>
   ...
   <tr>
	 ...
	 <br /><br />
	    ...
	    <tr>
	       ...
	       <form action="set_invoice_v2.php" method="Post" name="invoice_form" onsubmit="return validate_invoice_num()">
	    <tr>
		  ...
		  <select name="invoice_select" onchange="document.invoice_form.submit(this.form)">
			...
			$invoice_num = $HTTP_COOKIE_VARS["invoice_num"];
   			...
   			// get available invoice #'s
                        $stmt = "select distinct invoice_num from bill_header 
	    ...
	    <tr>
		   ...
		   <table border="0">
			 ...
			 <td width="30%" align="left">
			    <form action="reset_invoice_v2.php" method="Post">
...
<?
   if ($invoice_num != "") {
	...
	array_push($valid_asset, $row['FLEX_VALUE']);
      ...
      $stmt = "select bh.billing_num, bh.billing_type, bd.detail_line, bh.commodity_code, nvl(bd.service_code_det, bh.service_code) the_serv, bd.gl_code, bd.asset_code 
				from bill_header bh, bill_detail bd
				where invoice_num = $invoice_num
					and bh.billing_num = bd.billing_num
					and (bd.detail_line_status is null or bd.detail_line_status != 'DELETED')
				order by bh.billing_num, bd.detail_line";
      $ora_success = ora_parse($bni_cursor, $stmt);
      $ora_success = ora_exec($bni_cursor);	
   ...
   <tr>
	 ...
	 <p><font size="2" face="Verdana">Update Invoice (# <?= $invoice_num ?>)</font></p>
	    ...
	    <tr>
	       ...
	       <td align="center" width="14%" nowrap><font size="2" face="Verdana"><u>Billing Detail Line</u></font></td>
	       ...
	       <td align="center" width="20%" nowrap><font size="2" face="Verdana"><u>Asset Code</u></font></td>
            ...
            <form name="update_form" action="update_invoice_process_v2.php" method="Post" onsubmit="return validate_update()">
...
?>
 	    ...
 	    <tr>
	       <td align="center"><font size="2" face="Verdana"><?= $row['BILLING_NUM'] ?></font><input type="hidden" name="billing_num[]" value="<?= $row['BILLING_NUM'] ?>"></td>
	       <td align="center"><font size="2" face="Verdana"><?= $row['DETAIL_LINE'] ?></font><input type="hidden" name="detail_line[]" value="<?= $row['DETAIL_LINE'] ?>"></td>
	       <td align="center"><font size="2" face="Verdana"><?= $row['BILLING_TYPE'] ?></font></td>
 	       <td align="center"><select name="commodity_code[]">
                     <option value=""></option>
<?                
...
?>
	       ...
	       <td align="center"><select name="service_code[]">
                     <option value=""></option>
<?                
         foreach ($valid_serv as $service_code) {
			if ($row['THE_SERV'] == $service_code) {
...
?>
	       ...
	       <td align="center"><select name="gl_code[]">
                     <option value=""></option>
<?                
...
?>
	       ...
	       <td align="center"><select name="asset_code[]">
                     <option value=""></option>
<?                
...
?>
		...
		<tr>
			<td align="right" colspan="3"><font size="2" face="Verdana"><b>Currently:</b></font></td>
			<td align="center"><font size="2" face="Verdana"><? echo $row['COMMODITY_CODE']; ?></font></td>
			<td align="center"><font size="2" face="Verdana"><? echo $row['THE_SERV']; ?></font></td>
			<td align="center"><font size="2" face="Verdana"><? echo $my_gl_code; ?></font></td>
			<td align="center"><font size="2" face="Verdana"><? echo $row['ASSET_CODE']; ?></font></td>
		</tr>
<?
      } while (ora_fetch_into($bni_cursor, $row, ORA_FETCHINTO_NULLS|ORA_FETCHINTO_ASSOC));
?>
