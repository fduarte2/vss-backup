...
?>
      <form name="select_type" method="post" action="print_prebill_process.php" onsubmit="return validate_form()">
         <input name="generate_type" type="hidden" value="PREINVOICE">
...
?>	 
	    <tr>
	       ...
	       <td width="50%"><font size="2" face="Verdana">Advance Billing for Vessel #: <input type="text" name="AB_LR_NUM" size="10"></input>
 			</font><font size="1" face="Verdana">(Type 'ALL' for all vessels)</font></td>
	       <td width="6%">
		  <input type="radio" name="billing_type" value="BNI Storage" onclick="check(this.value)"></td>
	       <td width="48%"><font size="2" face="Verdana">BNI Storage</font></td>
	    </tr>
	    <tr>
               <td>&nbsp;</td>
	       <td>
	    ...
	    <tr>
	       ...
	       <td><font size="2" face="Verdana">Miscellaneous<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Optional - Date: <input type="text" name="misc_date" size="10">  Customer: <input type="text" name="misc_cust" size="10"></font><br><font size="2" face="Verdana">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Vessel #: <input type="text" name="MISC_LR_NUM" size="10"></input></font><font size="1" face="Verdana">(optional:  leave blank for ALL)</font></td>
