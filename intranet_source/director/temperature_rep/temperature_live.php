...
//   $pdf = new Cezpdf('letter','portrait');
   ...
   $arrHeading = array('box'=>'<b>Box</b>','temp'=>'<b>Actual</b>','actul_set'=>'<b>Set For</b>','set_point'=>'<b>Request</b>','effective'=>'<b>Start</b>','expired'=>'<b>End</b>','user'=>'<b>By</b>','prod'=>'<b>Commodity</b>','comments'=>'<b>Supervisor Comments</b>');
   $arrCol = array('box'=>array('width'=>29, 'justification'=>'center'),
                   'temp'=>array('width'=>60, 'justification'=>'center'),
                   'actul_set'=>array('width'=>50, 'justification'=>'center'),
                   'set_point'=>array('width'=>50, 'justification'=>'center'),
                   'effective'=>array('width'=>45, 'justification'=>'center'),
                   'expired'=>array('width'=>45, 'justification'=>'center'),
                   'prod'=>array('width'=>60, 'justification'=>'center'),
                   'user'=>array('width'=>50, 'justification'=>'center'),
...
*/
   ...
   for ($i = 0; $i < $rows; $i++){
   	...
   	if(ora_fetch($lcs_cursor)){
		...
		if ($expired <>"") $expired = date('m/d/y', strtotime($expired));
  		...
  		if ($prod == "" && $set_point <> "None" )
      		...
      		if ($box <> "Unknown"){
           		...
           		$pComm = ucwords(strtolower($pComm));
            		array_push($data[$j], array('whse'=>$whse, 'box'=>$box, 'temp'=>$temp, 'actul_set'=>$actual_set_point, 'set_point'=>$set_point, 'effective'=>$effective, 'expired'=>$expired, 'prod'=>$prod,'user'=>$user,'comments'=>$comments));
    		}
...
//   if($HTTP_SERVER_VARS["argv"][1]<>"email"){
  	...
  	$tmp = array('b'=>'Helvetica-Bold.afm', 'i'=>'Helvetica-Oblique.afm', 'bi'=>'Helvetica-BoldOblique.afm', 'ib'=>'Helvetica-BoldOblique.afm');
   	...
   	$pdf->ezSetDy(-10);
   	$pdf->ezText("<i>As of ". date('m/d/Y h:i A')." </i>", 12, $center);
...
*/
	...
	if ($out_of_range > 0)
		$pdf->ezText("<i>*Out-of-Range</i>", 8, $left);
