<?
   ...
   $user_types = split("-", $user_type);
    ...
    $path = "/upload/cubes/finance/";
    $engr_cube = $path."ENGR.cube";
    $exec_cube = $path."EXEC.cube";
    $fina_cube = $path."FINC.cube";
    $hrsc_cube = $path."HRSC.cube";
    $mark_cube = $path."MARK.cube";
    $oper_cube = $path."OPER.cube";
    $tsfs_cube = $path."TSFS.cube";
    $misc_cube = $path."MISC.cube";

    $cubeFile = "";
//    if ($user_type <>"") $cubeFile ="/upload/cubes/".$user_type.".cube";
    if(stristr($user_occ,"Engineering Director") != false || stristr($user_occ,"Controller") != false || stristr($user_occ,"Financial Analyst") != false || array_search('ROOT', $user_types) !== false ){
	$cubeFile = $engr_cube;
    }else if (stristr($user_occ,"Exceutive Director") != false ){
	$cubeFile = $exec_cube;
    }else if (stristr($user_occ,"Finance and Administration Director") != false){
	$cubeFile = $fina_cube;
    }else if (stristr($user_occ,"Human Resources Director") != false ){
	$cubeFile = $hrsc_cube;
    }else if (stristr($user_occ,"Marketing Director") != false ){
	$cubeFile = $mark_cube;
    }else if (stristr($user_occ,"Operations Director") != false ){
	$cubeFile = $oper_cube;
    }else if (stristr($user_occ,"Technology Solutions Director") != false ){
 	$cubeFile = $tsfs_cube;
    }
?>
...
<tr>
 ...
 <!--Cube Controls -->
<? if (stristr($user_occ,"Financial Analyst") != false || stristr($user_occ,"Controller") != false || array_search('ROOT', $user_types) !== false ){ ?>
 <select id="selCube" onchange="CubeOpen(this.value)" title="Select microcube to open">
  <option value="<? echo $engr_cube ?>">ENGR
  <option value="<? echo $exec_cube ?>">EXEC
  <option value="<? echo $fina_cube ?>">FNIA
  <option value="<? echo $hrsc_cube ?>">HRSC
  <option value="<? echo $mark_cube ?>">MARK
  <option value="<? echo $oper_cube ?>">OPER
  <option value="<? echo $tsfs_cube ?>">TSFS
  <option value="<? echo $misc_cube ?>">MISC
 </select>
<? } ?>
