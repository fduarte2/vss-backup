...
//    if ($user_type <>"") $cubeFile ="/upload/cubes/".$user_type.".cube";
    if($user_type =="ENG" || $user_type=="CNTL" || $user_type == "SYS"){
	$cubeFile = $engr_cube;
...
<tr>
 ...
 <!--Cube Controls -->
<? if ($user_type=="CNTL" || $user_type == "SYS"){ ?>
...
<tr>
 ...
 <OBJECT CLASSID="clsid:5220cb21-c88d-11cf-b347-00aa00a28331" VIEWASTEXT>
  <PARAM NAME="LPKPath" VALUE="/upload/ActiveX/cx_license.lpk">
 </OBJECT>

 <!-- ContourCube control -->
 <object classid="clsid:CCA2C672-33FD-11D5-8D72-005004532BDF" id="ContourCubeX1"  CODEBASE="/upload/ActiveX/ccubex.cab#version=-1,-1,-1,-1" width="100%" height="500" VIEWASTEXT>
