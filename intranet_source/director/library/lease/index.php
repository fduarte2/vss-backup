<?
  ...
  $user = $userdata['username'];
   ...
   function array_sort($array, $key)
   {
    ...
    $dir ="/web/web_pages/director/library/lease";
...
<table border="0" width="100%" cellpadding="4" cellspacing="0">
   <tr>
      ...
      <td>
	    ...
	    <font size="5" face="Verdana" color="#0066CC">DSP_MMP Lease & Easement - 4/1/2008
	    </font>
	    <hr>
...
?>
   <tr>
      ...
      <td valign="top" width="70%">
        <a href="/director/library/lease/<?echo $sorted_doc_name[$i][fname]?>"><?echo $sorted_doc_name[$i][fname]?></a>
      </td>
   </tr>
