...
//	include 'class.ezpdf.php';
	$mailSubject = "Excel Version of Faxes sent to Border Crossings (New Bedford, MA), ".date('m/d/Y', mktime(0,0,0,date('m'),date('d')-1,date('Y')));
...
//	echo $sql."\n";
	...
	if(!ocifetch($ves_data)){
		...
		mail("", $mailSubject, "No faxes sent to border crossing.", $mailheaders);
		exit;
	} else { do {
		$mailTO = "";
