	...
	<tr>
		...
		<table border="1" width="100%" cellpadding="2" cellspacing="0">
			<tr>
				...
				<td width="30%" align="center"><font size="2" face="Verdana"><b>Goals / Projects / Tasks</b></font></td>
				...
				<td width="37%" align="center"><font size="2" face="Verdana"><b>Notes</b></font></td>
...
?>
				<td><font size="2" face="Verdana">&nbsp;<? echo $INNERrow['STAT_DATE']; ?></font></td>
				<td><font size="2" face="Verdana">
<?
				if($authorization == "EXEC"){
?>
					<a href="hot_topic_edit.php?row_id=<? echo $row['HT_ROW_ID']; ?>&det_id=<? echo $INNERrow['HT_DETAIL_ID']; ?>"><? echo $INNERrow['NOTES']; ?></a>
<?
				} else {
?>
					&nbsp;<? echo $INNERrow['NOTES']; ?>
...
<?
				if($TR_format_check == 0){
					if($authorization == "EXEC"){
?>
				<td align="center" rowspan="<? echo $num_details; ?>"><font size="2" face="Verdana"><a href="hot_topic_add_detail.php?row_id=<? echo $row['HT_ROW_ID']; ?>">Update</a></font></td>
...
?>
	...
	<tr>
		<td width="50%" align="center"><form name="action_1" action="hot_topic_add.php" method="post"><input type="hidden" name="auth" value="<? echo $authorization; ?>"><input type="submit" name="submit" value="Add New Topic" <? if($authorization != "EXEC"){?> disabled <?}?>></form></td>
...
?>
				<td align="center" rowspan="<? echo $num_details; ?>" colspan="2"><font size="2" face="Verdana"><a href="hot_topic_add_detail.php?row_id=<? echo $row['HT_ROW_ID']; ?>">Update</a></font></td>
<?
					} else {
?>
				<td align="center" rowspan="<? echo $num_details; ?>" colspan="2"><font size="2" face="Verdana">&nbsp;</font></td>
...
?>
	...
	<tr>
		<td width="50%" align="center"><form name="action_1" action="hot_topic_add.php" method="post"><input type="hidden" name="auth" value="<? echo $authorization; ?>"><input type="submit" name="submit" value="Add New Topic" <? if($authorization != "OPS"){?> disabled <?}?>></form></td>
...
?>
	...
	<tr>
		<td width="50%" align="center"><form name="action_1" action="hot_topic_add.php" method="post"><input type="hidden" name="auth" value="<? echo $authorization; ?>"><input type="submit" name="submit" value="Add New Topic" <? if($authorization != "MRKT"){?> disabled <?}?>></form></td>
...
?>
	...
	<tr>
		<td width="50%" align="center"><form name="action_1" action="hot_topic_add.php" method="post"><input type="hidden" name="auth" value="<? echo $authorization; ?>"><input type="submit" name="submit" value="Add New Topic" <? if($authorization != "TECH"){?> disabled <?}?>></form></td>
...
?>
	...
	<tr>
		<td width="50%" align="center"><form name="action_1" action="hot_topic_add.php" method="post"><input type="hidden" name="auth" value="<? echo $authorization; ?>"><input type="submit" name="submit" value="Add New Topic" <? if($authorization != "HR"){?> disabled <?}?>></form></td>
...
?>
	...
	<tr>
		<td width="50%" align="center"><form name="action_1" action="hot_topic_add.php" method="post"><input type="hidden" name="auth" value="<? echo $authorization; ?>"><input type="submit" name="submit" value="Add New Topic" <? if($authorization != "FINA"){?> disabled <?}?>></form></td>
...
?>
	...
	<tr>
		<td width="50%" align="center"><form name="action_1" action="hot_topic_add.php" method="post"><input type="hidden" name="auth" value="<? echo $authorization; ?>"><input type="submit" name="submit" value="Add New Topic" <? if($authorization != "ENG"){?> disabled <?}?>></form></td>
