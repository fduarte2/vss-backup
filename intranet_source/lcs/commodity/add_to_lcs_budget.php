...
<table border="0" width="100%" cellpadding="4" cellspacing="0">
   <tr>
      <td>
	 <p align="left">
	    <font size="5" face="Verdana" color="#0066CC">Add entry to LCS budget table</font>
	    <hr>
	 </p>
      </td>
   </tr>
...
<table border="0" width="100%" cellpadding="4" cellspacing="0">
<form name="add_detail" action="/lcs/commodity/index.php" method="post">
   <tr>
      <td width="1%">&nbsp;</td>
...
<?
  $sql = "SELECT * FROM COMMODITY ORDER BY COMMODITY_CODE";
...
?>
   ...
   <tr>
	  ...
	  <td><input type="text" maxlength="5" size="10" name="NewFtl"></td>
   </tr>
   <tr>
      <td width="3%" colspan="2">&nbsp;</td>
	  <td><font size="2" face="Verdana">LTL:</font></td>
	  <td><input type="text" maxlength="5" size="10" name="NewLtl"></td>
   </tr>
   <tr>
      <td width="3%" colspan="2">&nbsp;</td>
