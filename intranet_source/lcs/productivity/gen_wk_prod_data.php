<?
	...
	*/
	...
	//$cmd = "echo ".$body." | mutt -s \"Weekly Productivity Data\" -a ".$writtenFile." hdadmin@port.state.de.us";

	system($cmd, $stat);

	printf("Weekly productivity data for " . $sDate . "-" .  $eDate . " has been emailed to you<br>" );
