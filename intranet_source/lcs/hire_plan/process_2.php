...
//   $sql = "select user_id from lcs_user where user_name= '$sup'";
   ...
   $sql = "delete from hire_plan_test where type = '$type' and hire_date = to_date('$hDate','mm/dd/yyyy') and supervisor = '$sup'";
   $statement = ora_parse($cursor, $sql);
   ora_exec($cursor);
