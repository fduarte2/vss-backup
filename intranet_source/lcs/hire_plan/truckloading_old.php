...
function changeDate(){
  ...
  document.location = 'truckloading.php?vDate='+vDate;
}

function updateChange(i, isFTL){
  i = i * 12 + 3;
...
<input type="textbox" name="hdate" size=10 value="<? echo $tomorrow; ?>" onChange="changeDate()">
      <a href="javascript:show_calendar('hire_request.hdate');" onmouseover="window.status='Date Picker';return true;" onmouseout="window.status='';return true;" onChange="changeDate()"><img src="/images/show-calendar.gif" width=24 height=22 border=0></a></td>
   ...
   <tr>
	...
	<table border="1" width="90%" cellpadding="0" cellspacing="0">
	   <tr>
	       ...
	       <td align="center"><b>Warehouse</b></td>
               ...
               <td align="center"><b>Productivity <nobr>(PLT/Man Hour)</nobr></b></td>
               <td align="center"><b>Budget</b></td>
               <td align="center"><b>Productivity - Budget</b></td>
               <td align="center"><b>&nbsp;</b></td>		
	   </tr>
	<? 
   	   $sql = "select type, location, num_of_hire, tot_hours, num_of_ftl, num_of_ltl, commodity, comments, plts, productivity, budget, prod_budget from hire_plan where type = 'TRUCKLOADING' and hire_date = to_date('$tomorrow','mm/dd/yyyy') and supervisor = '$user' order by location";
	   $statement = ora_parse($cursor, $sql);
	   ora_exec($cursor);
	...
	<? for($j = 0; $j < $index; $j++){ 
 	...
 	?>
        ...
        <? } ?>		   
	       ...
	       <td><input type="text" name="num[]" value = "<?echo $num?>" size = "2" onChange ="updateChange(<? echo $i?>, 'N')"></td>
	       <td><input type="text" name="hours[]" value = "<?echo $hours?>" size="3" onChange ="updateChange(<? echo $i?>, 'N')"></td>	
	       <td><input type="text" name="ftl[]" value = "<?echo $ftl?>" size = "2" onChange ="updateChange(<? echo $i?>,'Y')"></td>
	       <td><input type="text" name="ltl[]" value = "<?echo $ltl?>" size = "2" onChange ="updateChange(<? echo $i?>,'Y')"></td>
               <td><select name="comm[]" width = "10" onChange ="updateChange(<? echo $i?>,'N')">
	...
	?>
    	...
    	<? } ?>
               ...
               <td><input type="text" name="plt[]" value = "<?echo $plt?>" size = "3" onChange ="updateChange(<? echo $i?>,'N')"></td>
               <td><input type="text" name="prod[]" value = "<?echo $prod?>" size = "12" onChange ="updateChange(<? echo $i?>,'N')"></td>
               <td><input type="text" name="budget[]" value = "<?echo $budget?>" size = "4" onChange ="updateChange(<? echo $i?>,'N')"></td>
               <td><input type="text" name="prod_budget[]" value = "<?echo $prod_budget?>" size = "10" onChange ="updateChange(<? echo $i?>,'N')"></td>
               <td><input type="text" name="flag[]"  size = "12" onChange ="updateChange(<? echo $i?>,'N')"></td>
   ...
   <tr><td colspan="3">
	...
	<input type = "hidden" name = "type" value = "TRUCKLOADING">
	</td>
   </tr>
</table>
</form>
