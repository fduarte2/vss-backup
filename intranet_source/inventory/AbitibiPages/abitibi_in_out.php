...
************************************************************************************/
  ...
  $title = "Inventory - Abitibi Inbound/Outbound Activity Report";
  $area_type = "INVE";
...
<table border="0" width="100%" cellpadding="4" cellspacing="0">
   <tr>
      <td width="1%">&nbsp;</td>
      <td>
         <font size="5" face="Verdana" color="#0066CC">Abitibi Inbound/Outbound Activity Report</font>
         <br />
         <hr>
      </td>
   </tr>
...
<table border="0" width="100%" cellpadding="4" cellspacing="0"> 
<form name="the_form" action="abitibi_in_out.php" method="post">
	<tr>
...
<table border="1" width="100%" cellpadding="4" cellspacing="0"> 
	<tr>
		<td colspan="5" align="center"><font size="4" face="Verdana"><b>Abitibi <? echo $in_or_out ?> Report</b></font></td>
	</tr>
	<tr>
		...
		<td><font size="3" face="Verdana">Weight (KG)</font></td>
	</tr>
<?
		...
		$sql .= " AND SERVICE_CODE ".$service_code_sql." AND (ACTIVITY_DESCRIPTION IS NULL OR ACTIVITY_DESCRIPTION LIKE 'DMG%')
		AND CUSTOMER_ID = '312' 
...
<?
			$sql = "SELECT DISTINCT ORDER_NUM FROM CARGO_ACTIVITY WHERE TO_CHAR(DATE_OF_ACTIVITY, 'MM/DD/YYYY') = '".$date_row['THE_DATE']."' AND SERVICE_CODE ".$service_code_sql." AND (ACTIVITY_DESCRIPTION IS NULL OR ACTIVITY_DESCRIPTION LIKE 'DMG%') AND CUSTOMER_ID = '312' ORDER BY ORDER_NUM";
...
?>
	<tr bgcolor="#FF3300">
		<td>&nbsp;</td>
		<td colspan="4"><font size="2" face="Verdana"><b><? echo $order_row['ORDER_NUM']; ?></b></font></td>
	</tr>
<?
				$sql = "SELECT TO_CHAR(DATE_OF_ACTIVITY, 'MM/DD/YYYY HH24:MI') THE_ACT, ORDER_NUM, CT.PALLET_ID, CARGO_DESCRIPTION, WEIGHT FROM CARGO_TRACKING CT, CARGO_ACTIVITY CA WHERE CT.PALLET_ID = CA.PALLET_ID AND CT.RECEIVER_ID = '312' AND CA.SERVICE_CODE ".$service_code_sql." AND (ACTIVITY_DESCRIPTION IS NULL OR ACTIVITY_DESCRIPTION LIKE 'DMG%') AND CUSTOMER_ID = '312' AND TO_CHAR(DATE_OF_ACTIVITY, 'MM/DD/YYYY') = '".$date_row['THE_DATE']."' AND CA.ARRIVAL_NUM = CT.ARRIVAL_NUM AND ORDER_NUM = '".$order_row['ORDER_NUM']."' ORDER BY PALLET_ID";
...
?>
	<tr bgcolor="#FFCC99">
		<td>&nbsp;</td>
		<td colspan="2"><font size="2" face="Verdana"><b><? echo $order_row['ORDER_NUM']; ?> Total:</b></font></td>
