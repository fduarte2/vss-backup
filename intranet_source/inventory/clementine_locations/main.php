...
<table align=center >
	...
	<td> <!-- Insert the grid. Note the id of the grid 'myGrid' which is used to reference the control. --> 
	    <eba:gridlist id="myGrid" getHandler="gethandler.php" saveHandler="savehandler.php" height="400" width="925" cellHeight="16" showNav="Y" onbeforesave="OnBeforeSave()" onaftersave="OnAfterSave()" onError="errorHandler()" onGenerateRecordKey="generateKey()">
		<eba:ColumnDefinition type="TEXT" label="PALLET_ID" width="190" xdatafld="PALLET_ID" />
		<eba:ColumnDefinition type="TEXT" label="CARGO SIZE" width="150" xdatafld="CARGO_SIZE" />
		<eba:columndefinition type="TEXT" label="EXPORTER CODE"  width="150"  xdatafld="EXPORTER_CODE" />
                <eba:columndefinition type="TEXT" label="WAREHOUSE LOCATION"  width="150"  xdatafld="WAREHOUSE_LOCATION"  />
                <eba:columndefinition type="NUMBER" label="COMMODITY CODE"  width="175"  xdatafld="COMMODITY_CODE"  />
