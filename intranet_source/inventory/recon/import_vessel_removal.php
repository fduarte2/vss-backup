...
<table border="0" width="100%" cellpadding="4" cellspacing="0">
   <tr>
	...
	<tr>
      <td width="1%">&nbsp;</td>
		<td align="center"><font size="3" face="Verdana" color="ff0f00">Disclaimer:  This page is intended to allow for accidental / incorrect vessel imports to be backed out.<BR>To maintain data integrity, this page will NOT work if a vessel has either had activity run against its cargo, or has already been billed in some way.<br>In those cases, TS will need to be called to intervene.</font>
		<hr></td>
	</tr>
</table>
...
?>
	<tr>
		<td align="center"><font size="2" face="Verdana">This vessel has already had activity run against it.  Please contact TS if you still need it removed.</font></td>
	</tr>
<?
