...
$sql = "select EXPORTER_ID, EXPORTER_NAME from EXPORTER_PROFILE";
...
$getHandler->DefineField("EXPORTER_ID");
$getHandler->DefineField("EXPORTER_NAME");
...
{
	$getHandler->CreateNewRecord($results[$i]['EXPORTER_ID']);
	$getHandler->DefineRecordFieldValue("EXPORTER_ID", $results[$i]['EXPORTER_ID']);	// set ID
	$getHandler->DefineRecordFieldValue("EXPORTER_NAME", $results[$i]['EXPORTER_NAME']);	// set cargo size
