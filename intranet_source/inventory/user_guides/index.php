<?
  ...
  if($access_denied){
    ...
    $dir ="/web/web_pages/inventory/user_guides/";
...
?>
   <tr>
      ...
      <td valign="top" width="70%">
        <a href="/inventory/user_guides/<?echo $sorted_doc_name[$i][fname]?>"><?echo $sorted_doc_name[$i][fname]?></a>
      </td>
   </tr>
