...
<table border="1" width="100%" cellpadding="4" cellspacing="0"> 
	<tr>
		<td colspan="5" align="center"><font size="4" face="Verdana"><b>Dold DT <? echo $in_or_out ?> Report</b></font></td>
	</tr>
	<tr>
...
<?
				$sql = "SELECT TO_CHAR(DATE_OF_ACTIVITY, 'MM/DD/YYYY HH24:MI') THE_ACT, ORDER_NUM, CT.PALLET_ID, CARGO_DESCRIPTION, WEIGHT FROM CARGO_TRACKING CT, CARGO_ACTIVITY CA WHERE CT.PALLET_ID = CA.PALLET_ID AND CT.REMARK = 'DOLEPAPERSYSTEM' AND CT.BOL = CA.BATCH_ID AND CA.SERVICE_CODE ".$service_code_sql." AND ACTIVITY_DESCRIPTION IS NULL AND CUSTOMER_ID IN (SELECT CUSTOMER_ID FROM DOLEPAPER_EDI_IMPORT_CUSTOMERS) AND TO_CHAR(DATE_OF_ACTIVITY, 'MM/DD/YYYY') = '".$date_row['THE_DATE']."' AND ORDER_NUM = '".$order_row['ORDER_NUM']."' ORDER BY PALLET_ID";
...
?>
	<tr bgcolor="#FFCC99">
		...
		<td colspan="2"><font size="2" face="Verdana"><b><? echo $total_order; ?></b></font></td>
	</tr>
<?
			}
?>
	<tr bgcolor="#CCFF99">
		...
		<td colspan="2"><font size="2" face="Verdana"><b><? echo $total_date; ?></b></font></td>
	</tr>
<?
		}
?>
