<?
  ...
  $title = "Inventory System - BNI CUSTOMERS";
  $area_type = "INVE";
...
<table width="99%" bgcolor="#f0f0f0" border="0" cellpadding="4" cellspacing="4">
      ...
      <tr>
         ...
         <td align="right" valign="top">
            <font size="2" face="Verdana">Customer Name:</font></td>
         <td align="left">
            <input type="textbox" name="customer_name" value="<? echo $row['CUSTOMER_NAME'] ?>" size="40" maxlength="40">
         </td>
         <td>&nbsp;</td>
      </tr>
      <tr>
...
<td align="left">
      ...
      <tr>
         ...
         <td align="left">
            <input type="textbox" name="email" value="<? echo $row['CUSTOMER_EMAIL'] ?>" size="30" maxlength="80">
         </td>
         <td>&nbsp;</td>
      </tr>
      <tr>
