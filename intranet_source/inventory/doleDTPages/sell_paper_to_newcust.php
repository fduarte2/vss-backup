...
*
*	This page handles the sale of paper between customers (DT)
*
*************************************************************************/
...
//		printf(ora_errorcode($conn));
	...
	if($submit == "Transfer Roll"){
		...
		if($new_cust == "" || $order_num == ""){
			echo "<font size=\"2\" color=\"#FF0000\">Both a New Customer and a Order# must be entered.</font>";
...
<table border="0" width="100%" cellpadding="4" cellspacing="0">
	<tr>
		...
		<td>
	 <p align="left">
	    <font size="5" face="Verdana" color="#0066CC">Sell DT Paper to new Customer
</font>
	    <hr>
	 </p>
      </td>
...
<form name="select" action="sell_paper_to_newcust.php" method="post">
	<tr>
...
?>
<form name="delete" action="sell_paper_to_newcust.php" method="post">
...
<input type="hidden" name="arrival_num" value="<? echo $arrival_num; ?>">
	...
	<tr>
		<td width="100%"><font size="3" face="Verdana">DT#:  <? echo ociresult($short_term_data, "BOL"); ?></td>
	</tr>
	<tr>
		<td width="100%"><font size="3" face="Verdana">Description:  <? echo ociresult($short_term_data, "CARGO_DESCRIPTION"); ?></td>
	</tr>
	<tr>
