VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} DR_TimeOutException 
   Bindings        =   "DR_TimeOutException.dsx":0000
   Caption         =   "Time Out Exception Report"
   ClientHeight    =   7035
   ClientLeft      =   1650
   ClientTop       =   1545
   ClientWidth     =   10830
   ...
   BeginProperty Section0 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      ...
      BeginProperty Item1 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Object.Caption         =   "Time Out Exception Report"
         Alignment       =   2
      EndProperty
      ItemType2       =   3
      ...
      BeginProperty Item3 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Object.Caption         =   "EMPLOYEES WITH A MISMATCH IN END TIME OF HOURLY DETAIL AND TIME OUT FROM THEIR SWIPE CARD"
         Alignment       =   2
      EndProperty
   EndProperty
   SectionCode1    =   2
   ...
   EndProperty
End
Attribute VB_Name = "DR_TimeOutException"
