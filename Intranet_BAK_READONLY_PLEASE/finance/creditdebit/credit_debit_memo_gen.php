...
<form name="retrieve_invoice" action="credit_debit_memo_gen.php" method="post">
	...
	<tr>
		...
		<td><input type="radio" name="system" value="RF" <? if($system == "RF"){?>checked<?}?>>Scanned Storage Only&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<input type="radio" name="system" value="BNI"<? if($system != "RF"){?>checked<?}?>>All Other</td>
	</tr>
	<tr>
