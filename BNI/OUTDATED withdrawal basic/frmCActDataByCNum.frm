VERSION 5.00
Begin VB.Form frmCActDataByCNum 
   BackColor       =   &H00FFFFC0&
   Caption         =   "Cargo Activity Data Entry (Search By Order Number)"
   ClientHeight    =   9825
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   12315
   ...
   Begin VB.CommandButton cmdVesselList 
      Height          =   315
      Left            =   2130
      Picture         =   "frmCActDataByCNum.frx":0000
      Style           =   1  'Graphical
      TabIndex        =   114
      TabStop         =   0   'False
      Top             =   120
   ...
   Begin VB.CommandButton cmdRecipientList 
      Height          =   315
      Left            =   7980
      Picture         =   "frmCActDataByCNum.frx":0102
      Style           =   1  'Graphical
      TabIndex        =   113
      TabStop         =   0   'False
      Top             =   120
   ...
   Begin VB.CommandButton cmdCommodityList 
      Height          =   315
      Left            =   2130
      Picture         =   "frmCActDataByCNum.frx":0204
      Style           =   1  'Graphical
      TabIndex        =   112
      TabStop         =   0   'False
      Top             =   510
   ...
   Begin VB.ComboBox cboDelDetTransMode 
      Height          =   315
      ItemData        =   "frmCActDataByCNum.frx":0306
      Left            =   2670
      List            =   "frmCActDataByCNum.frx":0316
   ...
   Begin VB.PictureBox picDelDetIndex 
      ...
      Height          =   240
      Left            =   180
      Picture         =   "frmCActDataByCNum.frx":0339
      ScaleHeight     =   240
      ScaleWidth      =   240
      TabIndex        =   98
      TabStop         =   0   'False
   ...
   Begin VB.CommandButton cmdDelDetCustomerList 
      Height          =   315
      Left            =   6480
      Picture         =   "frmCActDataByCNum.frx":043B
      Style           =   1  'Graphical
      TabIndex        =   57
      TabStop         =   0   'False
      Top             =   1260
   ...
   Begin VB.CommandButton cmdDelDetBOL 
      Height          =   315
      Left            =   1650
      Picture         =   "frmCActDataByCNum.frx":053D
      Style           =   1  'Graphical
      TabIndex        =   55
      TabStop         =   0   'False
      Top             =   3600
   ...
   Begin VB.CommandButton cmdDelDetMark 
      Height          =   315
      Left            =   4920
      Picture         =   "frmCActDataByCNum.frx":063F
      Style           =   1  'Graphical
      TabIndex        =   54
      TabStop         =   0   'False
      Top             =   3600
   ...
   Begin VB.ListBox lstDelDetBOL 
      Height          =   1230
      ItemData        =   "frmCActDataByCNum.frx":0741
      Left            =   600
      List            =   "frmCActDataByCNum.frx":0743
      TabIndex        =   33
      Top             =   3930
      Width           =   1395
   End
   Begin VB.ListBox lstDelDetMark 
      Height          =   1230
      ItemData        =   "frmCActDataByCNum.frx":0745
      Left            =   2190
      List            =   "frmCActDataByCNum.frx":0747
      TabIndex        =   32
      Top             =   3930
      Width           =   3075
   End
   ...
   End
End
Attribute VB_Name = "frmCActDataByCNum"
...
'    Next i
    ...
    If Not IsNull(txtNotes.Text) Then
        ...
        While PostNotes <> ""
            If InStr(1, PostNotes, Chr$(13)) <> 0 Then ' figure out if there is a line break in PostNotes
                temp_post = Mid$(PostNotes, 1, InStr(1, PostNotes, Chr$(13)) - 1)
            Else
                temp_post = PostNotes
            End If
            
            AddrLineLength = Len(temp_post)
            
            ' remove the part of PostNotes about to be printed from PostNotes so loop properly continues.  CRLF takes 2 extra positions.
            PostNotes = Mid$(PostNotes, (AddrLineLength + 3))
        
            If Len(temp_post) > 50 Then
                Printer.Print Tab(23); Mid$(temp_post, 1, 50)
                Printer.Print Tab(23); Mid$(temp_post, 51)
                Num_Of_Lines = Num_Of_Lines + 2
            Else
                Printer.Print Tab(23); Mid$(temp_post, 1)
                Num_Of_Lines = Num_Of_Lines + 1
            End If
        Wend
    End If
...
Private Sub cmdSaveDelivery_Click()
    ...
    If Trim$(txtDeliveryNum.Text) = "" Then
        ...
        Set dsCARGO_DELIVERY_MAX = OraDatabase.DbCreateDynaset(gsSqlStmt, 0&)
        If OraDatabase.LastServerErr = 0 And dsCARGO_DELIVERY_MAX.RECORDCOUNT > 0 Then
            If IsNull(dsCARGO_DELIVERY_MAX.fields("SEQVALUE").Value) Then
                lDeliveryNum = 1
            Else
                lDeliveryNum = dsCARGO_DELIVERY_MAX.fields("SEQVALUE").Value
            End If
        Else
            lDeliveryNum = 1
        End If
            ...
            If OraDatabase.LastServerErr = 0 And dsCARGO_MANIFEST.RECORDCOUNT > 0 Then
                ...
                If OraDatabase.LastServerErr = 0 And dsCARGO_TRACKING.RECORDCOUNT > 0 Then
                    ...
                    Else
                        ...
                        dsCARGO_ACTIVITY.fields("ORDER_NUM").Value = Left$(txtDelDetOrderNum.Text, 12)
...
Private Sub txtDelDetOrderNum_LostFocus()
    Dim i As Integer
    Dim j As Integer
    ...
    gsSqlStmt = "SELECT * FROM CARGO_ACTIVITY WHERE SERVICE_CODE = 6200 AND ORDER_NUM='" & Trim(txtDelDetOrderNum.Text) & "'"
    'Set dsCARGO_DELIVERY = OraDatabase.DbCreateDynaset(gsSqlStmt, 0&)
    Set dsCARGO_ACTIVITY = OraDatabase.DbCreateDynaset(gsSqlStmt, 0&)
    If OraDatabase.LastServerErr = 0 And dsCARGO_ACTIVITY.RECORDCOUNT > 0 Then
        iDetIndex = 0
        'Do While Not dsCARGO_DELIVERY.EOF
        Do While Not dsCARGO_ACTIVITY.EOF
            'Now get the cargo manifest information
            gsSqlStmt = "SELECT * FROM CARGO_MANIFEST WHERE CONTAINER_NUM = '" & dsCARGO_ACTIVITY.fields("LOT_NUM").Value & "' AND "
           ...
           'End If
            ...
            gsSqlStmt = "SELECT * FROM CARGO_ACTIVITY_EXT WHERE LOT_NUM = " & dsCARGO_ACTIVITY.fields("LOT_NUM").Value & " AND "
            gsSqlStmt = gsSqlStmt & "ACTIVITY_NUM = " & dsCARGO_ACTIVITY.fields("ACTIVITY_NUM").Value & " AND "
            gsSqlStmt = gsSqlStmt & "SERVICE_CODE = " & dsCARGO_ACTIVITY.fields("SERVICE_CODE").Value
            Set dsCARGO_ACTIVITY_EXT = OraDatabase.DbCreateDynaset(gsSqlStmt, 0&)
...
'                End If
          ...
          gsSqlStmt = "SELECT * FROM DELIVERY_ACTIVITY WHERE ORDER_NUM='" & Trim(txtDelDetOrderNum.Text) & "'"
          Set dsDelivery_Num = OraDatabase.DbCreateDynaset(gsSqlStmt, 0&)
          If IsNull(dsDelivery_Num.fields("DELIVERY_NUM")) Then
            txtDeliveryNum.Text = ""
          Else
            txtDeliveryNum.Text = dsDelivery_Num.fields("DELIVERY_NUM")
          End If
          If Not IsNull(dsDelivery_Num.fields("DELIVER_TO").Value) Then
            txtDelDetDeliverTo.Text = dsDelivery_Num.fields("DELIVER_TO").Value
          End If
          If Not IsNull(dsDelivery_Num.fields("DELIVERY_DESCRIPTION").Value) Then
            txtDelDetRemarks.Text = dsDelivery_Num.fields("DELIVERY_DESCRIPTION").Value
          End If
