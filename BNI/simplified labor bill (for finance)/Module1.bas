...
Global dsLabor_Ticket_Header As Object
Global dsLabor_Ticket As Object
...
'    Set OraDatabase3 = OraSession.OpenDatabase("PROD", "APPS/APPS", 0&)
...
'    Set OraDatabase2 = OraSession.OpenDatabase("BNITEST", "LABOR/LABOR_DEV", 0&)
    ...
    If OraDatabase.LastServerErr = 0 And OraDatabase2.LastServerErr = 0 Then 'And OraDatabase3.LastServerErr = 0 Then
        frmLaborBill.Show
    Else
        If OraDatabase.LastServerErr <> 0 Then
            MsgBox OraDatabase.LastServerErrText, vbCritical, sMsg
        ElseIf OraDatabase2.LastServerErr <> 0 Then
            MsgBox OraDatabase2.LastServerErrText, vbCritical, sMsg
'        Else
'            MsgBox OraDatabase3.LastServerErrText, vbCritical, sMsg
        End If
