...
Private Sub Form_Load()
    ...
    txtDateFrom.Text = Format$(Now - 30, "mm/dd/yyyy")
    Call FillGrid
End Sub
...
Sub FillGrid()
    ...
    gsSqlStmt = "SELECT * FROM CARGO_DELIVERY_DELETE WHERE DELETE_DATE >= TO_DATE('" & txtDateFrom.Text & "', 'MM/DD/YYYY') " _
            & " ORDER BY DELIVERY_NUM ASC"
