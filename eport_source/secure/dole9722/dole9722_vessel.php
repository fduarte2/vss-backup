...
//			$useable_data[($i - 1)]["cust"] = trim($data->sheets[0]['cells'][$i][3]);
			...
			$useable_data[($i - 1)]["BC"] = strtoupper(trim($data->sheets[0]['cells'][$i][4]));
...
//			echo "<br>BC: ".$useable_data[($i - 1)]["BC"]."  substr:  ".substr($useable_data[($i - 1)]["BC"], 0, 2)."  pared:  ".substr($useable_data[($i - 1)]["BC"], 2)."<br>";
...
//		exit;
		...
		if($upload_valid != ""){
			...
			system("/bin/mv $target_path_import $target_path_import"."error");
...
<table border="0" width="100%" cellpadding="4" cellspacing="0">
   <tr>
      ...
      <td>
	 <p align="left">
	    <font size="5" face="Verdana" color="#0066CC">Dole Fresh Vessel Upload
</font>
	    <hr>
	 </p>
      </td>
...
<table border="0" width="100%" cellpadding="4" cellspacing="0">
<form enctype="multipart/form-data" name="get_data" action="dole9722_vessel_index.php" method="post">
	<tr>
		<td><a href="./uploaded_manifests/?M=D">View Past Uploads</a><br><br></td>
	</tr>
	<tr>
		...
		<br>
		<font size="2" face="Verdana">(This is used as the Date the pallets in the file are received into Inventory.<br>If the discharge is more than 1 day, the pallets need to be split into more than one file.)</font>
	</tr>
	<tr>
		<td><a href="Sample.xls">Click Here</a> For a sample Vessel Invetory File.</td>
	</tr>
	<tr>
