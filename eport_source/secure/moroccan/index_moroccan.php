...
<html>
<head>
<title>Eport of Wilmington - Moroccan Home</title>
</head>
...
<table width="99%" Border="0" align="center" cellpadding="0" cellspacing="1">
   <tr>
      <td colspan = "2" width = "100%">
         <? include("/var/www/secure/moroccan/header.php"); ?> 
      </td>
   </tr>
   <tr>
      ...
      <td width = "90%" valign="top">
         <? include("/var/www/secure/moroccan/welcome.php"); ?>
	 <? include("/var/www/secure/moroccan/footer.php"); ?>
      </td>
   </tr>
</table>
