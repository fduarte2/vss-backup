...
include("../dspc_portal/functions/phpgrid/include/phpgrid.php");
/*
...
$dg -> set_gridpath     ("../dspc_portal/functions/phpgrid/include/");

$dg -> set_sql          ("SELECT DISTINCT ARRIVAL_NUM, BOL FROM CARGO_TRACKING WHERE REMARK = 'DOLEPAPERSYSTEM' ORDER BY ARRIVAL_NUM, BOL");
$dg -> set_sql_table    ("CT");
$dg -> set_sql_key      ("BOL");
