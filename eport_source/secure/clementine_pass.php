...
//   $row_num = pg_num_rows($result);
   ...
   // if records present
	$sql = "SELECT * FROM eport_login where username = '" . $web_user . "' and user_type like 'CLEM%'";
...
//		  echo $test_pass."<br>".$web_pass
// Incorrect password...
?>
<html>
<head>
<title>Clementine Login Error</title>
...
Password!  Please <a href="clementine_login.php">go back and try again.</a>
               </td>
            </tr>
         </table>
         </p>
...
<?
       ...
       $sql = "insert into eport_user_logins
				...
				values 
					('".$username."', SYSDATE, '".$ip_address."', '".$success."', 'clementine')";
		ora_parse($Short_Term_Cursor, $sql);
		ora_exec($Short_Term_Cursor);
       header("Location: clementine/index.php");
       exit;
      }
    }
	$sql = "insert into eport_user_logins
	...
	header("Location: clementine_login.php?input=1");
?>
