...
<table width="99%" Border="0" align="center" cellpadding="0" cellspacing="1">
   <tr>
      <td colspan = "2" width = "100%">
         <? include("/var/www/secure/clementine/header.php"); ?> 
      </td>
   </tr>
   <tr>
      <td width = "10%" valign = "top"  bgcolor="<? echo $left_color; ?>">
	    ...
	    <tr>
		  ...
		  <? include("/var/www/secure/clementine/leftnav.php"); ?>
	       </td>
	    </tr>
	 </table>
      </td>
      <td width = "90%" valign="top">
         <? include("clem_sizepkg_report_v2.php"); ?>
	 <? include("/var/www/secure/clementine/footer.php"); ?>
      </td>
   </tr>
</table>
