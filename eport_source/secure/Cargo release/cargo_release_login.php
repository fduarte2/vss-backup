<?
   ...
   if($user != "" && $type == "CARGO_REL"){
      header("Location: cargo_release/index_cargo.php");
      exit;
   }
?>
...
<html>
<head>
<title>Port of Wilmington Eport - Cargo Release Access Page</title>
</head>
	 ...
	 <table border="0" width="65%" cellpadding="4" cellspacing="0">
            <tr>
               <td width="1%">&nbsp;</td>
      	       <td>
         	  <p align="left">
            	  <font size="5" face="Verdana" color="#0066CC">Cargo Load Release Login</font>
            	  <hr>
         	  </p>
	       </td>
            </tr>
	 ...
	 <table border="0" width="65%" cellpadding="4" cellspacing="1">
	    <tr>
		  ...
		  <font size="3" face="Verdana" color="#000080">
		     <b>Welcome to the Cargo Load Release Login Page!</b>
		  </font><br /><br />
	    ...
	    <tr>
	       <td>&nbsp;</td>
	       <td align="center">
		  <form method="Post" action="cargo_release_pass.php">
