...
$palletId = $_GET['pallet_id'];
if ($palletId) {
	$palletSql = "AND t.pallet_id = '$palletId'";
}
...
if ($eport_customer_id == 9999){
  $stmt = "SELECT
				...
				TO_CHAR(date_received, 'MM/DD/YY HH24:MI:SS') AS date_received,
				qty_received,
				qty_damaged,
				manifested,
				batch_id,
			...
			FROM
				cargo_tracking t,
				customer_profile c,
				commodity_profile cm
			WHERE
				arrival_num = '$lr_num'
				AND T.receiver_id = C.customer_id
				AND T.commodity_code = CM.commodity_code
				AND T.receiver_id in (SELECT customer_id FROM eport_exped_auth WHERE username = '".$user."')
				$palletSql
			ORDER BY t.receiver_id, pallet_id";
} elseif ($eport_customer_id != 0) {
  $stmt = "SELECT
				pallet_id,
				cm.commodity_name AS commodity,
				c.customer_name AS customer,
...
face="Verdana">Description&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</font></th>
			<th nowrap onmouseover="return overlib('User-Defined Exporter Description', CAPTION, 'Exporter Code');" onmouseout="return nd();"><font size = "2" face="Verdana">Exporter Code</font></th>
			<th nowrap onmouseover="return overlib('Size', CAPTION, 'Cargo Size');" onmouseout="return nd();"><font size = "2" face="Verdana">Cargo Size</font></th>
			<th nowrap onmouseover="return overlib('User-Defined Descriptive Value', CAPTION, 'Batch ID');" onmouseout="return nd();"><font size = "2" face="Verdana">Batch ID</font></th>
		  <?
		     if ($eport_customer_id == 0) {
		  ?>
		 ...
		 do {
	       ...
	       ?>
			...
			<td><font size = "1" face="Verdana"><?= $row1['COMMODITY'] ?></font></td>
	                ...
	                <td><font size = "1" face="Verdana"><?= $row1['EXPORTER_CODE'] ?></font></td>
	                <td><font size = "1" face="Verdana"><?= $row1['CARGO_SIZE'] ?></font></td>
	                <td><font size = "1" face="Verdana"><?= $row1['BATCH_ID'] ?></font></td>
		  <?
		       if ($eport_customer_id == 0) {
		  ?>
...
color="red">Damage Total<br />
		     ...
		     <?
                     ...
                     ?>
                        <td align="center"><font size = "2" face="Verdana" color="#0066CC">Expected Total<br />
			   <?= $qty_expected_total ?></font></td>
                        <td align="center"><font size = "2" face="Verdana" color="#0066CC">Received Total<br />
			   <?= $qty_received_total ?></font></td>
		        <td align="center"><font size = "2" face="Verdana" color="#0066CC">Short Total<br />
			   <?= $qty_short_total ?></font></td>
		        <td align="center"><font size = "2" face="Verdana" color="#0066CC">Over Total<br />
			   <?= $qty_over_total ?></font></td>
                        <td align="center"><font size = "2" face="Verdana" color="#0066CC">% Scanned:<br />
