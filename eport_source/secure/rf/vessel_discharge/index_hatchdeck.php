<?
   ...
   $eport_user_v2 = $HTTP_COOKIE_VARS["eport_user_v2"];

   if($user == "" && $eport_user_v2 == ""){
...
<html>
<head>
<title>Port of Wilmington Eport - Vessel Discharge Reports</title>
</head>
