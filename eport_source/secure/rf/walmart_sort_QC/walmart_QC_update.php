			...
			if($bad_loc === false){
				...
				$sql = "INSERT INTO JOB_QUEUE
						...
						VALUES
							...
							'EMAIL',
							'WDIPULLS',
							'".$cur_ves.";".$data->sheets[0]['numRows']."',
							'PENDING')";
				ora_parse($cursor, $sql);
				ora_exec($cursor);

				echo "<font color=\"#0000FF\" size=\"4\"><b>".$data->sheets[0]['numRows']." Successfully Updated.<b></font><br>";
			} elseif($error_display != ""){
...
<table border="0" width="100%" cellpadding="4" cellspacing="0">
   <tr>
      ...
      <td>
	 <p align="left">
	    <font size="5" face="Verdana" color="#0066CC">QC: INSPECTION PALLETS (to be set aside for inspection - do not use this to set a pallet on HOLD)
</font>
	    <hr>
	 </p>
      </td>
