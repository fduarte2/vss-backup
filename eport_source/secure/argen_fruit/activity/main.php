   ...
   <tr>
	 ...
	 <font size="2" face="Verdana"><p>
      <?
	   ...
	   printf("Please enter an Order Number or an Activity date to view the Activity Report.  You will be able to see all customer Activity");
         ...
         printf("<br />Enter <b>either</b> an Order (or pallet) Number, or the Date.  Entering the Order (or pallet) Number will give you a Checker Tally report - Entering the Date will give you a summary of activity for the entire day.");
      ?>
         </p></font>
	 <table align="left" bgcolor="#f0f0f0" border="0" cellpadding="4" cellspacing="4">
	    ...
	    <tr>
	       <td width="5%">&nbsp;</td>
	       <td width="20%" align="right" valign="top">
	          <font size="2" face="Verdana">Pallet Number:</font></td>
	       <td width="55%" align="left">
                 <input type="textbox" name="pallet_num" size="22">
               </td>
               <td width="20%">&nbsp;</td>
	    </tr>
		<tr>
