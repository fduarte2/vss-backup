<?
   ...
   if($user == ""){
      header("Location: ../steel_login.php");
      exit;
   }
?>
...
<html>
<head>
<title>Eport of Wilmington - Steel Home</title>
</head>
   ...
   <tr>
      <td width = "10%" valign = "top"  bgcolor="<? echo $left_color; ?>">
	    ...
	    <tr>
		  ...
		  <? include("/var/www/secure/steel/leftnav.php"); ?>
	       </td>
	    </tr>
	 </table>
      </td>
      <td width = "90%" valign="top">
         <? include("steel_activity_main_scanned.php"); ?>
	 <? include("footer.php"); ?>
      </td>
   </tr>
</table>
