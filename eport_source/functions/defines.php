<?
 ...
 // EPORT_LOGIN
 define(EPORT_USERNAME, 0);
 define(EPORT_PASSWORD, 1);
 define(EPORT_ACTIVE, 2);
 define(EPORT_USER_TYPE, 3);
 define(EPORT_USER_SUB_TYPE, 4);
 define(EPORT_EMAIL, 5);
 define(EPORT_THEME, 6);
 define(EPORT_CUSTOMER_ID, 7);
 ...
 define(FG_COLOR, 2);
 define(LINK_COLOR, 3);
 define(VLINK_COLOR, 4);
 define(ALINK_COLOR, 5);
 define(BIG_TEXT, 6);
 define(LEFT_COLOR, 7);
 define(LEFT_TEXT, 8);
