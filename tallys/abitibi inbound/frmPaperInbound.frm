VERSION 5.00
Begin VB.Form frmPaperInbound 
   Caption         =   "Abitibi Inbound Tally"
   ClientHeight    =   5550
   ClientLeft      =   5145
   ClientTop       =   4500
   ClientWidth     =   7350
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Label Label4 
         Alignment       =   2  'Center
         AutoSize        =   -1  'True
         Caption         =   "AbitibiBowater Inbound Tally"
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   13.5
            Charset         =   0
   ...
   End
End
Attribute VB_Name = "frmPaperInbound"
...
', EMPLOYEE PE      NVL(SUBSTR(EMPLOYEE_NAME, 0, 8), 'NONE') THE_LOGIN,     AND TO_CHAR(CA.ACTIVITY_ID) = SUBSTR(PE.EMPLOYEE_ID(+), -4)
    strSql = "SELECT CT.PALLET_ID THE_PALLET, CT.CARGO_DESCRIPTION THE_MARK, CT.QTY_RECEIVED THE_REC, CT.QTY_UNIT THE_ROLLS, CA.ARRIVAL_NUM, CA.ACTIVITY_NUM, " _
            & "CT.WEIGHT THE_WEIGHT,  DECODE(TO_CHAR(QTY_DAMAGED), '0', 'N', 'Y') THE_DMG " _
            & "FROM CARGO_TRACKING CT, CARGO_ACTIVITY CA " _
            & "WHERE CT.PALLET_ID = CA.PALLET_ID AND CT.CONTAINER_ID = CA.ORDER_NUM AND CA.CUSTOMER_ID = CT.RECEIVER_ID " _
...
'        OraSession.Close
    ...
    Else
        ...
        dTotalRolls = 0
            ...
            Printer.FontSize = 11
            Printer.FontBold = True
            Printer.Print Tab(20); "PORT OF WILMINGTON TALLY - COMMERCIAL PAPER (Inbound)"
            Printer.Print ""
            Printer.Print ""
            Printer.Print Tab(10); "CUSTOMER: " & strCustName; Tab(65); "START TIME: " & strStartTime
            Printer.Print Tab(10); "ORDER NUMBER: " & txtOrderNum.Text; Tab(65); "END TIME: " & strEndTime
            Printer.Print ""
            Printer.FontSize = 10
            Printer.FontBold = False
            Printer.Print "BARCODE"; Tab(25); "MARK"; Tab(60); "QTY"; Tab(70); "ROLLS"; Tab(80); "WEIGHT"; Tab(95); "CHECKER"; Tab(115); "DMG"
...
'                strChecker = dsMAIN_DATA.Fields("THE_LOGIN").Value
                ...
                Printer.Print strBarcode; Tab(25); strMark; Tab(60); strQTY; Tab(70); strRolls; _
                Tab(80); dWT; Tab(95); strChecker; Tab(115); strDamage
...
'            Printer.Print Tab(45); "Total Cases:"; Tab(65); dTotalCases
            Printer.Print Tab(5); "Totals:"; Tab(55); dTotalPallets; Tab(64); dTotalRolls; Tab(75); dTotalWeight & " KG"
'            Printer.Print Tab(45); "Total Weight:"; Tab(65); dTotalWeight; " KG"
            ...
            If dsMAIN_DATA.RecordCount > 0 Then
                ...
                Printer.FontSize = 11
                Printer.FontBold = True
                Printer.Print Tab(10); "PORT OF WILMINGTON TALLY - COMMERCIAL PAPER (Inbound) - UNSCANNED CARGO"
                Printer.Print ""
                Printer.Print ""
                ...
                Printer.FontSize = 10
                Printer.FontBold = False
                Printer.Print "BARCODE"; Tab(25); "MARK"; Tab(60); "QTY"; Tab(70); "ROLLS"; Tab(80); "WEIGHT"
                Printer.Print Tab(70); "/PKG"
                Printer.Print Tab(1); "_____________________________________________________________________________________________________________________________________________________"
                ...
                While (Not dsMAIN_DATA.EOF)
                    ...
                    strQTY = dsMAIN_DATA.Fields("THE_REC").Value
                    strRolls = dsMAIN_DATA.Fields("THE_ROLLS").Value
                    Printer.Print strBarcode; Tab(25); strMark; Tab(60); strQTY; Tab(70); strRolls; Tab(80); dWT
                ...
                Printer.Print Tab(1); "====================================================================================================================================================="
                Printer.FontBold = True
                Printer.Print Tab(5); "Totals:"; Tab(55); dTotalPallets; Tab(75); dTotalWeight & " KG"
'                Printer.Print Tab(45); "Total Weight:"; Tab(65); dTotalWeight; " KG"
            End If
...
Sub ClearAllFields()
    ...
    frmPaperInbound.txtCustNum.Text = ""
    frmPaperInbound.txtOrderNum.Text = ""
    frmPaperInbound.txtCode.Text = ""
