...
*
*	OHL-release page for Canadian Program.
*************************************************************************/
...
//	}
	...
	$sql = "SELECT NVL(TO_CHAR(BROKER_STATUS, 'MM/DD/YYYY HH:MI:SS AM'), 'NONE') THE_RELEASE, BROKER_COMMENTS, NVL(T_AND_E, 'NONE') THE_TE, NVL(T_AND_E_DISPLAY, 'NONE') THE_TEDISP
	...
	$current_comments = ociresult($short_term_data, "BROKER_COMMENTS");
	if($current_comments == ""){
		$current_comments = "SET BY ".$user;
	}
	$current_te = ociresult($short_term_data, "THE_TE");
	$current_tedisp = ociresult($short_term_data, "THE_TEDISP");
...
<table border="0" width="100%" cellpadding="4" cellspacing="0">
   <tr>
      ...
      <td>
	 <p align="left">
	    <font size="5" face="Verdana" color="#0066CC">All Cargo Broker-Release</font><font size="3" face="Verdana" color="#0066CC">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Login: <? echo strtoupper($user);?>.&nbsp;&nbsp;&nbsp;&nbsp;Screen Refresh Date and Time: <? echo date('m/d/Y h:i:s a'); ?><br>&nbsp;&nbsp;&nbsp;PoW Vessel#:&nbsp;&nbsp;&nbsp;<? echo $vessel; ?><br>&nbsp;&nbsp;&nbsp;Container:&nbsp;&nbsp;&nbsp;<? echo $cont; ?><br>&nbsp;&nbsp;&nbsp;BoL:&nbsp;&nbsp;&nbsp;<? echo $bol; ?>
</font>
	    <hr>
	 </p>
      </td>
...
?>	
<table border="0" width="100%" cellpadding="4" cellspacing="0">
<form enctype="multipart/form-data" name="file_submit" action="canadian_scoreboard_index.php" method="post">
<input type="hidden" name="vessel" value="<? echo $vessel; ?>">
<input type="hidden" name="cont" value="<? echo $cont; ?>">
<input type="hidden" name="bol" value="<? echo $bol; ?>">
<input type="hidden" name="T_E_already_set" value="<? echo $current_te; ?>">
	<tr>
		...
		<td width="15%"><font size="2" face="Verdana">Current T&E:</font></td>
<?
		if($current_te != "NONE"){
?>
		<td><font size="2" face="Verdana"><a href="./upload_t_e/<? echo $current_te; ?>"><? echo $current_tedisp; ?></a></font></td>
<?
		} else {
?>
		<td><font size="2" face="Verdana">None</font></td>
<?
		}
?>
	</tr>
		<td width="15%"><font size="2" face="Verdana">New/Replace T&E:</font></td>
		<td><input type="file" name="import_file"></td>
	</tr>	
	<tr>
		<td colspan="2"><input type="submit" name="submit" value="Set Broker Release Time and Comments">&nbsp;&nbsp;&nbsp;<input type="submit" name="submit" value="Remove Broker Release"><hr></td>
	</tr>
</form>
</table>
<?
