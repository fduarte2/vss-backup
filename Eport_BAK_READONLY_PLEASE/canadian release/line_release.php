...
//	}
	...
	$sql = "SELECT NVL(TO_CHAR(LINE_STATUS, 'MM/DD/YYYY HH:MI:SS AM'), 'NONE') THE_RELEASE, LINE_COMMENTS
	...
	$current_comments = ociresult($short_term_data, "LINE_COMMENTS");
...
<table border="0" width="100%" cellpadding="4" cellspacing="0">
   <tr>
      ...
      <td>
	 <p align="left">
	    <font size="5" face="Verdana" color="#0066CC">All Cargo Line-Release</font><font size="3" face="Verdana" color="#0066CC">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Login: <? echo strtoupper($user);?>.&nbsp;&nbsp;&nbsp;&nbsp;Screen Refresh Date and Time: <? echo date('m/d/Y h:i:s a'); ?><br>&nbsp;&nbsp;&nbsp;PoW Vessel#:&nbsp;&nbsp;&nbsp;<? echo $vessel; ?><br>&nbsp;&nbsp;&nbsp;Container:&nbsp;&nbsp;&nbsp;<? echo $cont; ?><br>&nbsp;&nbsp;&nbsp;BoL:&nbsp;&nbsp;&nbsp;<? echo $bol; ?>
</font>
	    <hr>
	 </p>
      </td>
...
<input type="hidden" name="bol" value="<? echo $bol; ?>">
	...
	<tr>
		<td colspan="2"><input type="submit" name="submit" value="Set Line Release Time and Comments">&nbsp;&nbsp;&nbsp;<input type="submit" name="submit" value="Remove Line Release"><hr></td>
	</tr>
</form>
</table>
<?
