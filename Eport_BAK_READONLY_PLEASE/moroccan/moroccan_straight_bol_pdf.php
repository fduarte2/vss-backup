...
//	$pdf->ezStartPageNumbers(700,10,8,'right');
	...
	if(!ocifetch($stid)){
		...
		array_push($shipfrom_table, array('SHIPPED FROM'=>"DOMINION CITRUS"));
		...
		$pdf->ezSetY(390);
		$pdf->ezText("<b><u>REFRIGERATION INSTRUCTION:</u></b>", 8, $left);
		$pdf->ezSetY(390);
		$pdf->ezText("<b><i>TEMPERATURE TO BE MAINTAINED AT 39 deg. F</i></b>", 8, array('aleft'=>200));
		$pdf->ezSetY(380);
		$pdf->ezText("<b><i>TEMP RECORDER #</i></b>", 8, array('aleft'=>200));
		$pdf->ezSetY(370);
		$pdf->ezText("<b>BORDER CROSSING POINT:</b>", 8, $left);
		$pdf->ezSetY(370);
		$pdf->ezText("<b>".$bordercross."</b>", 8, array('aleft'=>200));
		...
		$pdf->ezSetY(150);
		$pdf->ezText("<b>SEAL# ".$seal."</b>", 8, $left);
