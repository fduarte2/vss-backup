...
// This file implements the code-behind class for EditDC_TransporterPage.aspx.
// App_Code\EditDC_TransporterPage.Controls.vb contains the Table, Row and Record control classes
...
partial class EditDC_TransporterPage
        : BaseApplicationPage
// Code-behind class for the EditDC_TransporterPage page.
    ...
    public void LoadData_Base()
    {
            ...
            try {
                ...
                if ((!this.IsPostBack)) {
                    ...
                    this.DC_TransporterRecordControl.LoadData();
                    this.DC_TransporterRecordControl.DataBind();           
          ...
          if (TargetKey != null){
            ...
            try {
                ...
                if (!this.IsPageRefresh) {
                    ...
                    this.DC_TransporterRecordControl.SaveData();
            ...
            if (this.DC_TransporterRecordControl!= null && this.DC_TransporterRecordControl.DataSource != null){
                id = this.DC_TransporterRecordControl.DataSource.TransporterId.ToString();
                value = this.DC_TransporterRecordControl.DataSource.GetValue(this.DC_TransporterRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(DFKA)).ToString();
                if(value == null){
                  value = id;
                }
