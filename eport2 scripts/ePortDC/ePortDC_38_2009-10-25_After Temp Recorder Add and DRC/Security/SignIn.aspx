...
<%@ Register Tagprefix="ePortDC" TagName="SignIn_Control" Src="../Shared/SignIn_Control.ascx" %>
...
<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" CodeFile="SignIn.aspx.cs" Inherits="ePortDC.UI.SignIn" %>
		...
		<table cellspacing="0" cellpadding="0" border="0" class="pbTable">
			...
			<tr>
				...
				<td class="pcC">			
					...
					<tr>
					<td>
						<ePortDC:Menu runat="server" id="Menu" HiliteSettings="Menu9MenuItem">
		</ePortDC:Menu>
					</td>
					</tr>
					<tr>
...
<table cellspacing="0" cellpadding="0" border="0" class="dv">
 <tr>
	...
	<td class="dht" valign="middle"><asp:Literal runat="server" id="DialogTitle" Text="&lt;%# GetResourceValue(&quot;Txt:SignIn&quot;, &quot;ePortDC&quot;) %>">
		</asp:Literal></td>
	...
	<ePortDC:SignIn_Control runat="server" id="SignInControl">
		</ePortDC:SignIn_Control>
	...
	<table cellpadding="0" cellspacing="0" border="0" style="padding-top:10px; padding-bottom:5px;" id="Table1" align="center">
		<tr>
		<td><ePortDC:ThemeButton runat="server" id="OKButton" Button-CausesValidation="True" Button-CommandName="Login" Button-Text="&lt;%# GetResourceValue(&quot;Btn:OK&quot;, &quot;ePortDC&quot;) %>">
