...
// ShowDC_CustomsBrokerOfficePage.aspx page.  The Row or RecordControl classes are the 
...
namespace ePortDC.UI.Controls.ShowDC_CustomsBrokerOfficePage
{
...
// Base class for the DC_ConsigneeTableControlRow control on the ShowDC_CustomsBrokerOfficePage page.
...
public class BaseDC_ConsigneeTableControlRow : ePortDC.UI.BaseApplicationRecordControl
{
        ...
        public virtual void SaveData()
        {
            ...
            // DC_CustomsBrokerOffice in DC_CustomsBrokerOfficeRecordControl is One To Many to DC_ConsigneeTableControl.
                    
            // Setup the parent id in the record.
            DC_CustomsBrokerOfficeRecordControl recDC_CustomsBrokerOfficeRecordControl = (DC_CustomsBrokerOfficeRecordControl)this.Page.FindControlRecursively("DC_CustomsBrokerOfficeRecordControl");
            if (recDC_CustomsBrokerOfficeRecordControl != null && recDC_CustomsBrokerOfficeRecordControl.DataSource == null) {
                // Load the record if it is not loaded yet.
                recDC_CustomsBrokerOfficeRecordControl.LoadData();
            }
            if (recDC_CustomsBrokerOfficeRecordControl == null || recDC_CustomsBrokerOfficeRecordControl.DataSource == null) {
            ...
            this.DataSource.CustomsBrokerOfficeId = recDC_CustomsBrokerOfficeRecordControl.DataSource.CustomsBrokerOfficeId;
...
// Base class for the DC_ConsigneeTableControl control on the ShowDC_CustomsBrokerOfficePage page.
...
public class BaseDC_ConsigneeTableControl : ePortDC.UI.BaseApplicationTableControl
{
    ...
    // Setup default pagination settings.
        ...
        DC_CustomsBrokerOfficeRecordControl parentRecordControl = (DC_CustomsBrokerOfficeRecordControl)(this.Page.FindControlRecursively("DC_CustomsBrokerOfficeRecordControl"));
            DC_CustomsBrokerOfficeRecord parentRec = parentRecordControl.GetRecord();
            if (parentRec == null) {
                // Get the error message from the application resource file.
                throw new Exception(Page.GetResourceValue("Err:ParentNotInitialized", "ePortDC"));
            }
           
            if (parentRec.CustomsBrokerOfficeIdSpecified) {
                wc.iAND(DC_ConsigneeTable.CustomsBrokerOfficeId, BaseFilter.ComparisonOperator.EqualsTo, parentRec.CustomsBrokerOfficeId.ToString());
            } else {
                wc.RunQuery = false;
                return wc;
            }
        ...
        public virtual WhereClause CreateWhereClause(String searchText, String fromSearchControl, String AutoTypeAheadSearch, String AutoTypeAheadWordSeparators)
        {
            ...
            wc.iAND(DC_ConsigneeTable.CustomsBrokerOfficeId, BaseFilter.ComparisonOperator.EqualsTo, pkValue.GetColumnValue(DC_CustomsBrokerOfficeTable.CustomsBrokerOfficeId).ToString());
                
                } else {
              
            wc.iAND(DC_ConsigneeTable.CustomsBrokerOfficeId, BaseFilter.ComparisonOperator.EqualsTo, recId);
        ...
        report.SpecificReportFileName = Page.Server.MapPath("ShowDC_CustomsBrokerOfficePage.DC_ConsigneePDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "DC_Consignee";
                // If ShowDC_CustomsBrokerOfficePage.DC_ConsigneePDFButton.report specifies a valid report template,
            ...
            ((DC_CustomsBrokerOfficeRecordControl)(this.Page.FindControlRecursively("DC_CustomsBrokerOfficeRecordControl"))).ResetData = true;
...
#region "Helper Functions"
        ...
        public DC_ConsigneeTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (DC_ConsigneeTableControlRow[])(selectedList.ToArray(Type.GetType("ePortDC.UI.Controls.ShowDC_CustomsBrokerOfficePage.DC_ConsigneeTableControlRow")));
        ...
        public DC_ConsigneeTableControlRow[] GetRecordControls()
        {
            ...
            return (DC_ConsigneeTableControlRow[])recList.ToArray(Type.GetType("ePortDC.UI.Controls.ShowDC_CustomsBrokerOfficePage.DC_ConsigneeTableControlRow"));
        }
...
// Base class for the DC_CustomsBrokerOfficeRecordControl control on the ShowDC_CustomsBrokerOfficePage page.
...
public class BaseDC_CustomsBrokerOfficeRecordControl : ePortDC.UI.BaseApplicationRecordControl
{
        ...
        protected virtual void Control_Init(object sender, System.EventArgs e)
        {
            // Register the event handlers.
              ...
              this.DC_CustomsBrokerOfficeDialogEditButton.Click += new ImageClickEventHandler(DC_CustomsBrokerOfficeDialogEditButton_Click);
        }
        ...
        public virtual void LoadData()  
        {
            ...
            if (recList.Length == 0) {
                throw new Exception(Page.GetResourceValue("Err:NoRecRetrieved", "ePortDC"));
                    ...
                    this.DataSource = DC_CustomsBrokerOfficeTable.GetRecord(recList[0].GetID().ToXmlString(), true);
        ...
        public virtual WhereClause CreateWhereClause()
        {
            ...
            if (recId == null || recId.Length == 0) {
                // Get the error message from the application resource file.
                throw new Exception(Page.GetResourceValue("Err:UrlParamMissing", "ePortDC").Replace("{URL}", "DC_CustomsBrokerOffice"));
            }
        ...
        protected override object SaveViewState()
        {
            ...
            return base.SaveViewState();
              ...
              // event handler for ImageButton
              public virtual void DC_CustomsBrokerOfficeDialogEditButton_Click(object sender, ImageClickEventArgs args)
              {
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.ImageButton DC_CustomsBrokerOfficeDialogEditButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "DC_CustomsBrokerOfficeDialogEditButton");
            }
        }
