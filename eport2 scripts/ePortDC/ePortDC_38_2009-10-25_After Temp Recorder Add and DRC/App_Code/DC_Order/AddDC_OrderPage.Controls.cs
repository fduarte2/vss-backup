...
// AddDC_OrderPage.aspx page.  The Row or RecordControl classes are the 
...
namespace ePortDC.UI.Controls.AddDC_OrderPage
{
...
public class DC_OrderDetailTableControlRow : BaseDC_OrderDetailTableControlRow
{
	...
	protected void FillDetailFields()
	{
		...
		// Get price from Customer Price and fill
...
public class DC_OrderRecordControl : BaseDC_OrderRecordControl
{
	...
	// BN - Change the Order Status to SUBMITTED if Submit button is clicked
	public override void GetUIData()
	{
		...
		// Using a label because otherwise can not identify Submit button clicked
	    if (this.OrderStatusSubmitLabel.Text == "SubmitButton")
	    {
	    	// Using a label because otherwise can not identify Submit button clicked
			...
			if (myRecord.CustomerId == 440)
			{
				...
				myRecord.OrderStatusId = 3; //PICKLIST COMPLETE
			...
			{
			    myRecord.OrderStatusId = 2; //SUBMITTED
			}
	    }
	    
		// Set Totals to Zero
 		myRecord.TotalBoxDamaged = 0;
 		myRecord.TotalCount = 0;
 		myRecord.TotalPalletCount = 0;
 		myRecord.TotalPrice = 0;
 		myRecord.TotalQuantityKG = 0;
	} 
	...
	{
		// Show Vessel Id
		ePortVesselCookie.Text = VesselId.SelectedItem.Value;
	...
	// BN - Select OrderStatus as DRAFT 
	protected override void PopulateOrderStatusIdDropDownList(string selectedValue, int maxItems)
	{
	    ...
	    // Get the listItem with text "DRAFT"
	    li = this.OrderStatusId.Items.FindByText("DRAFT");
	...
	// BN - Select Commodity as CLEMENTINE 
	protected override void PopulateCommodityCodeDropDownList(string selectedValue, int maxItems)
	{
		...
		// Get default commodity code from config
		string sCommodityCodeDefault = System.Configuration.ConfigurationManager.AppSettings.Get("ePortCommodityCodeDefault");

	    // Get the listItem with value of the default commodity code
	    li = this.CommodityCode.Items.FindByValue(sCommodityCodeDefault);
	...
	// BN - Select Transport Entry status as PENDING
	protected override void PopulateTEStatusDropDownList(string selectedValue, int maxItems)
	{
	    ...
	    // Get the listItem with text "PENDING"
	    li = this.TEStatus.Items.FindByText("PENDING");
	...
	// BN - Select Direct Order as DIRECT
	protected override void PopulateDirectOrderDropDownList(string selectedValue, int maxItems)
	{
	    ...
	    // Get the listItem with text "DIRECT"
	    li = this.DirectOrder.Items.FindByText("DIRECT");
	...
	// BN - Select Load Type as CUSTOMER LOAD
	protected override void PopulateLoadTypeDropDownList(string selectedValue, int maxItems)
	{
	    ...
	    // Get the listItem with text "DIRECT"
	    li = this.LoadType.Items.FindByText("CUSTOMER LOAD");
	...
	protected override void PopulateVesselIdDropDownList(string selectedValue, int maxItems)
	{
	    ...
	    // Get the listItem with value of the vessel cookie
	    li = this.VesselId.Items.FindByValue(ePortVesselCookie.Text);
...
// Base class for the DC_OrderDetailTableControlRow control on the AddDC_OrderPage page.
...
// Base class for the DC_OrderDetailTableControl control on the AddDC_OrderPage page.
...
#region "Helper Functions"
        ...
        public DC_OrderDetailTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (DC_OrderDetailTableControlRow[])(selectedList.ToArray(Type.GetType("ePortDC.UI.Controls.AddDC_OrderPage.DC_OrderDetailTableControlRow")));
        ...
        public DC_OrderDetailTableControlRow[] GetRecordControls()
        {
            ...
            return (DC_OrderDetailTableControlRow[])recList.ToArray(Type.GetType("ePortDC.UI.Controls.AddDC_OrderPage.DC_OrderDetailTableControlRow"));
        }
...
// Base class for the DC_OrderRecordControl control on the AddDC_OrderPage page.
...
public class BaseDC_OrderRecordControl : ePortDC.UI.BaseApplicationRecordControl
{
        ...
        protected virtual void Control_Load(object sender, System.EventArgs e)
        {
                  ...
                  this.Page.Authorize((Control)OrderStatusId, "NO_ACCESS");
        ...
        public virtual void LoadData()  
        {
            ...
            if (recList.Length == 0) {
                throw new Exception(Page.GetResourceValue("Err:NoRecRetrieved", "ePortDC"));
                    ...
                    this.DataSource = (DC_OrderRecord)DC_OrderRecord.Copy(recList[0], false);
        ...
        public virtual void GetUIData()
        {
            ...
            foreach(BaseColumn col in DC_OrderRecord.TableUtils.TableDefinition.Columns){
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.Label CustomerBrokerLabel {
            get {
                return (System.Web.UI.WebControls.Label)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "CustomerBrokerLabel");
            }
        }
        ...
        public System.Web.UI.WebControls.Label ePortVesselCookie {
            get {
                return (System.Web.UI.WebControls.Label)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "ePortVesselCookie");
            }
        }
