...
// ShowDC_CommodityPage.aspx page.  The Row or RecordControl classes are the 
...
namespace ePortDC.UI.Controls.ShowDC_CommodityPage
{
...
// Base class for the DC_CommodityRecordControl control on the ShowDC_CommodityPage page.
...
public class BaseDC_CommodityRecordControl : ePortDC.UI.BaseApplicationRecordControl
{
        ...
        protected virtual void Control_Init(object sender, System.EventArgs e)
        {
            // Register the event handlers.
              ...
              this.DC_CommodityDialogEditButton.Click += new ImageClickEventHandler(DC_CommodityDialogEditButton_Click);
        }
        ...
        public virtual void LoadData()  
        {
            ...
            if (recList.Length == 0) {
                throw new Exception(Page.GetResourceValue("Err:NoRecRetrieved", "ePortDC"));
                    ...
                    this.DataSource = DC_CommodityTable.GetRecord(recList[0].GetID().ToXmlString(), true);
        ...
        public virtual WhereClause CreateWhereClause()
        {
            ...
            if (recId == null || recId.Length == 0) {
                ...
                throw new Exception(Page.GetResourceValue("Err:UrlParamMissing", "ePortDC").Replace("{URL}", "DC_Commodity"));
            }
        ...
        protected override object SaveViewState()
        {
            ...
            return base.SaveViewState();
              ...
              public virtual void DC_CommodityDialogEditButton_Click(object sender, ImageClickEventArgs args)
              {
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.ImageButton DC_CommodityDialogEditButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "DC_CommodityDialogEditButton");
            }
        }
