...
/// <see cref="DC_ConsigneeTable">ePortDC.DC_ConsigneeTable</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="DC_ConsigneeTable"></seealso>
public class DC_ConsigneeDefinition
{
#region "Definition (XML) for DC_ConsigneeDefinition table"
	//Next 281 lines contain Table Definition (XML) for table "DC_ConsigneeDefinition"
...
@"<XMLDefinition Generator=""Iron Speed Designer"" Version=""5.0"" Type=""GENERIC"">" +
  @"<ColumnDefinition>" +
    ...
    @"<Column InternalName=""1"" Priority=""2"" ColumnNum=""1"">" +
      ...
      @"<columnUIName>Address</columnUIName>" +
    ...
    @"<Column InternalName=""2"" Priority=""3"" ColumnNum=""2"">" +
      ...
      @"<columnUIName Source=""User"">Customs Broker Office</columnUIName>" +
      @"<columnType>Number</columnType>" +
      @"<columnDBType>smallint</columnDBType>" +
      @"<columnLengthSet>5.0</columnLengthSet>" +
      @"<columnDefault></columnDefault>" +
      ...
      @"<columnTableAliasName></columnTableAliasName>" +
      @"<foreignKey>" +
        @"<columnFKName>FK_DC_Consignee_DC_CustomsBrokerOffice</columnFKName>" +
        @"<columnFKTable>ePortDC.Business.DC_CustomsBrokerOfficeTable, App_Code</columnFKTable>" +
        @"<columnFKOwner>dbo</columnFKOwner>" +
        @"<columnFKColumn>CustomsBrokerOfficeId</columnFKColumn>" +
        @"<columnFKColumnDisplay>CustomsBroker</columnFKColumnDisplay>" +
    ...
    @"<Column InternalName=""3"" Priority=""4"" ColumnNum=""3"">" +
      ...
      @"<columnUIName>City</columnUIName>" +
      @"<columnType>String</columnType>" +
      @"<columnDBType>nvarchar</columnDBType>" +
    ...
    @"<Column InternalName=""5"" Priority=""6"" ColumnNum=""5"">" +
      @"<columnName>ConsigneeName</columnName>" +
      @"<columnUIName>Consignee Name</columnUIName>" +
      @"<columnType>String</columnType>" +
      @"<columnDBType>nvarchar</columnDBType>" +
      @"<columnLengthSet>30</columnLengthSet>" +
      @"<columnDefault></columnDefault>" +
    ...
    @"<Column InternalName=""6"" Priority=""7"" ColumnNum=""6"">" +
      ...
      @"<columnUIName Source=""User"">Customer</columnUIName>" +
      @"<columnType>Number</columnType>" +
      @"<columnDBType>smallint</columnDBType>" +
      @"<columnLengthSet>5.0</columnLengthSet>" +
      @"<columnDefault></columnDefault>" +
      ...
      @"<columnTableAliasName></columnTableAliasName>" +
      @"<foreignKey>" +
        @"<columnFKName>FK_DC_Consignee_DC_Customer1</columnFKName>" +
        @"<columnFKTable>ePortDC.Business.DC_CustomerTable, App_Code</columnFKTable>" +
        @"<columnFKOwner>dbo</columnFKOwner>" +
        @"<columnFKColumn>CustomerId</columnFKColumn>" +
        @"<columnFKColumnDisplay>CustomerShortName</columnFKColumnDisplay>" +
        @"<foreignKeyType>Explicit</foreignKeyType>" +
      "</foreignKey>" +
      @"<columnCodeName></columnCodeName>" +
    ...
    @"<Column InternalName=""8"" Priority=""9"" ColumnNum=""8"">" +
      @"<columnName>PhoneMobile</columnName>" +
      @"<columnUIName>Phone Mobile</columnUIName>" +
      @"<columnType>String</columnType>" +
      @"<columnDBType>nvarchar</columnDBType>" +
      @"<columnLengthSet>25</columnLengthSet>" +
      @"<columnDefault></columnDefault>" +
    ...
    @"<Column InternalName=""9"" Priority=""10"" ColumnNum=""9"">" +
      ...
      @"<columnUIName>Postal Code</columnUIName>" +
      @"<columnType>String</columnType>" +
      @"<columnDBType>nvarchar</columnDBType>" +
    ...
    @"<Column InternalName=""10"" Priority=""11"" ColumnNum=""10"">" +
      @"<columnName>StateProvince</columnName>" +
      @"<columnUIName>State Province</columnUIName>" +
      @"<columnType>String</columnType>" +
      @"<columnDBType>nvarchar</columnDBType>" +
      @"<columnLengthSet>30</columnLengthSet>" +
      @"<columnDefault></columnDefault>" +
    ...
    "</Column>" +
  "</ColumnDefinition>" +
  @"<TableName>DC_Consignee</TableName>" +
  @"<Version></Version>" +
  @"<Owner>dbo</Owner>" +
  @"<TableCodeName>DC_Consignee</TableCodeName>" +
  @"<TableAliasName>DC_Consignee_</TableAliasName>" +
  ...
  @"<TableStoredProcPrefix>pePortDCDC_Consignee</TableStoredProcPrefix>" +
"</XMLDefinition>";
#endregion

	/// <summary>
	/// Gets the embedded schema and configuration data for the  
	/// <see cref="DC_ConsigneeTable"></see>
