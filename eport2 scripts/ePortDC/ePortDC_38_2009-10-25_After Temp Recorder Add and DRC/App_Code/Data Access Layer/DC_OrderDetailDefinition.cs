...
/// <see cref="DC_OrderDetailTable">ePortDC.DC_OrderDetailTable</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="DC_OrderDetailTable"></seealso>
public class DC_OrderDetailDefinition
{
#region "Definition (XML) for DC_OrderDetailDefinition table"
	//Next 341 lines contain Table Definition (XML) for table "DC_OrderDetailDefinition"
...
@"<XMLDefinition Generator=""Iron Speed Designer"" Version=""5.0"" Type=""GENERIC"">" +
  @"<ColumnDefinition>" +
    @"<Column InternalName=""0"" Priority=""1"" ColumnNum=""0"">" +
      ...
      @"<foreignKey>" +
        @"<columnFKName>FK_DC_OrderDetail_DC_Order</columnFKName>" +
        @"<columnFKTable>ePortDC.Business.DC_OrderTable, App_Code</columnFKTable>" +
        @"<columnFKOwner>dbo</columnFKOwner>" +
        @"<columnFKColumn>OrderNum</columnFKColumn>" +
        @"<columnFKColumnDisplay>DriverName</columnFKColumnDisplay>" +
    ...
    @"<Column InternalName=""3"" Priority=""4"" ColumnNum=""3"">" +
      @"<columnName>DeliveredQty</columnName>" +
      @"<columnUIName>Delivered Quantity</columnUIName>" +
      @"<columnType>Number</columnType>" +
    ...
    @"<Column InternalName=""4"" Priority=""5"" ColumnNum=""4"">" +
      @"<columnName>OrderQty</columnName>" +
      @"<columnUIName>Order Quantity</columnUIName>" +
      @"<columnType>Number</columnType>" +
      @"<columnDBType>smallint</columnDBType>" +
      @"<columnLengthSet>5.0</columnLengthSet>" +
      @"<columnDefault></columnDefault>" +
    ...
    @"<Column InternalName=""5"" Priority=""6"" ColumnNum=""5"">" +
      @"<columnName>OrderSizeId</columnName>" +
      @"<columnUIName>Order Size</columnUIName>" +
      @"<columnType>Number</columnType>" +
      @"<columnDBType>smallint</columnDBType>" +
      @"<columnLengthSet>5.0</columnLengthSet>" +
      @"<columnDefault></columnDefault>" +
      ...
      @"<columnTableAliasName></columnTableAliasName>" +
      @"<foreignKey>" +
        @"<columnFKName>FK_DC_OrderDetail_DC_CommoditySize</columnFKName>" +
    ...
    "</Column>" +
  "</ColumnDefinition>" +
  @"<TableName>DC_OrderDetail</TableName>" +
  @"<Version>5</Version>" +
  @"<Owner>dbo</Owner>" +
  @"<TableCodeName>DC_OrderDetail</TableCodeName>" +
  @"<TableAliasName>DC_OrderDetail_</TableAliasName>" +
  ...
  @"<TableStoredProcPrefix>pePortDCDC_OrderDetail</TableStoredProcPrefix>" +
"</XMLDefinition>";
#endregion

	/// <summary>
	/// Gets the embedded schema and configuration data for the  
	/// <see cref="DC_OrderDetailTable"></see>
