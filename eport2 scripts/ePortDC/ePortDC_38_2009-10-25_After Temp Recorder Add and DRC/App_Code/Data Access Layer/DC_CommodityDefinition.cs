...
/// <see cref="DC_CommodityTable">ePortDC.DC_CommodityTable</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="DC_CommodityTable"></seealso>
public class DC_CommodityDefinition
{
#region "Definition (XML) for DC_CommodityDefinition table"
	//Next 83 lines contain Table Definition (XML) for table "DC_CommodityDefinition"
...
@"<XMLDefinition Generator=""Iron Speed Designer"" Version=""5.0"" Type=""GENERIC"">" +
  @"<ColumnDefinition>" +
    ...
    @"<Column InternalName=""1"" Priority=""2"" ColumnNum=""1"">" +
      @"<columnName>CommodityName</columnName>" +
      @"<columnUIName>Commodity Name</columnUIName>" +
    ...
    @"<Column InternalName=""2"" Priority=""3"" ColumnNum=""2"">" +
      @"<columnName>HarmonizedSystemTariff</columnName>" +
      @"<columnUIName>Harmonized System Tariff</columnUIName>" +
      @"<columnType>String</columnType>" +
      @"<columnDBType>nchar</columnDBType>" +
    ...
    "</Column>" +
  "</ColumnDefinition>" +
  @"<TableName>DC_Commodity</TableName>" +
  @"<Version>2</Version>" +
  @"<Owner>dbo</Owner>" +
  @"<TableCodeName>DC_Commodity</TableCodeName>" +
  @"<TableAliasName>DC_Commodity_</TableAliasName>" +
  ...
  @"<TableStoredProcPrefix>pePortDCDC_Commodity</TableStoredProcPrefix>" +
"</XMLDefinition>";
#endregion

	/// <summary>
	/// Gets the embedded schema and configuration data for the  
	/// <see cref="DC_CommodityTable"></see>
