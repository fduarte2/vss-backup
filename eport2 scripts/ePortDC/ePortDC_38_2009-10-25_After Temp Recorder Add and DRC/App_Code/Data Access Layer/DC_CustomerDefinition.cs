...
/// <see cref="DC_CustomerTable">ePortDC.DC_CustomerTable</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="DC_CustomerTable"></seealso>
public class DC_CustomerDefinition
{
#region "Definition (XML) for DC_CustomerDefinition table"
	//Next 303 lines contain Table Definition (XML) for table "DC_CustomerDefinition"
...
@"<XMLDefinition Generator=""Iron Speed Designer"" Version=""5.0"" Type=""GENERIC"">" +
  @"<ColumnDefinition>" +
    ...
    @"<Column InternalName=""4"" Priority=""5"" ColumnNum=""4"">" +
      ...
      @"<columnUIName>Customer Name</columnUIName>" +
      @"<columnType>String</columnType>" +
      @"<columnDBType>nvarchar</columnDBType>" +
      @"<columnLengthSet>50</columnLengthSet>" +
      @"<columnDefault></columnDefault>" +
    ...
    @"<Column InternalName=""5"" Priority=""6"" ColumnNum=""5"">" +
      @"<columnName>CustomerShortName</columnName>" +
      @"<columnUIName>Customer Short Name</columnUIName>" +
      @"<columnType>String</columnType>" +
      @"<columnDBType>nvarchar</columnDBType>" +
      @"<columnLengthSet>30</columnLengthSet>" +
      @"<columnDefault></columnDefault>" +
    ...
    @"<Column InternalName=""6"" Priority=""7"" ColumnNum=""6"">" +
      @"<columnName>DestCode</columnName>" +
      @"<columnUIName>Destination Code</columnUIName>" +
      @"<columnType>String</columnType>" +
      @"<columnDBType>nvarchar</columnDBType>" +
    ...
    @"<Column InternalName=""7"" Priority=""8"" ColumnNum=""7"">" +
      @"<columnName>NeedPARS</columnName>" +
      @"<columnUIName>Need PARS</columnUIName>" +
      @"<columnType>Boolean</columnType>" +
      @"<columnDBType>bit</columnDBType>" +
      @"<columnLengthSet></columnLengthSet>" +
      @"<columnDefault></columnDefault>" +
      @"<columnDBDefault>((0))</columnDBDefault>" +
      @"<columnIndex>N</columnIndex>" +
      @"<columnUnique>N</columnUnique>" +
      @"<columnFunction></columnFunction>" +
      @"<columnDBFormat></columnDBFormat>" +
    ...
    @"<Column InternalName=""8"" Priority=""9"" ColumnNum=""8"">" +
      ...
      @"<columnUIName>Origin</columnUIName>" +
      @"<columnType>String</columnType>" +
      @"<columnDBType>nvarchar</columnDBType>" +
      @"<columnLengthSet>30</columnLengthSet>" +
      @"<columnDefault></columnDefault>" +
    ...
    "</Column>" +
  "</ColumnDefinition>" +
  @"<TableName>DC_Customer</TableName>" +
  @"<Version>3</Version>" +
  @"<Owner>dbo</Owner>" +
  @"<TableCodeName>DC_Customer</TableCodeName>" +
  @"<TableAliasName>DC_Customer_</TableAliasName>" +
  ...
  @"<TableStoredProcPrefix>pePortDCDC_Customer</TableStoredProcPrefix>" +
"</XMLDefinition>";
#endregion

	/// <summary>
	/// Gets the embedded schema and configuration data for the  
	/// <see cref="DC_CustomerTable"></see>
