...
// AddDC_CustomerPage.aspx page.  The Row or RecordControl classes are the 
...
namespace ePortDC.UI.Controls.AddDC_CustomerPage
{
...
// Base class for the DC_CustomerRecordControl control on the AddDC_CustomerPage page.
...
public class BaseDC_CustomerRecordControl : ePortDC.UI.BaseApplicationRecordControl
{
        ...
        public virtual void LoadData()  
        {
            ...
            if (recList.Length == 0) {
                throw new Exception(Page.GetResourceValue("Err:NoRecRetrieved", "ePortDC"));
                    ...
                    this.DataSource = (DC_CustomerRecord)DC_CustomerRecord.Copy(recList[0], false);
        ...
        public virtual void GetUIData()
        {
            ...
            foreach(BaseColumn col in DC_CustomerRecord.TableUtils.TableDefinition.Columns){
