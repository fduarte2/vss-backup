...
// ShowDC_CustomerPage.aspx page.  The Row or RecordControl classes are the 
...
namespace ePortDC.UI.Controls.ShowDC_CustomerPage
{
...
// Base class for the DC_ConsigneeTableControlRow control on the ShowDC_CustomerPage page.
...
public class BaseDC_ConsigneeTableControlRow : ePortDC.UI.BaseApplicationRecordControl
{
        ...
        public override void DataBind()
        {
            ...
            if (this.DataSource.AddressSpecified) {
                ...
                this.Address1.Text = DC_ConsigneeTable.Address.Format(DC_ConsigneeTable.Address.DefaultValue);
            }
            ...
            if (this.DataSource.CitySpecified) {
                ...
                this.City1.Text = formattedValue;
                        
            } else {  
                this.City1.Text = DC_ConsigneeTable.City.Format(DC_ConsigneeTable.City.DefaultValue);
            }
                    
            if (this.City1.Text == null ||
                this.City1.Text.Trim().Length == 0) {
                this.City1.Text = "&nbsp;";
            }
            ...
            if (this.DataSource.CommentsSpecified) {
                ...
                this.Comments1.Text = DC_ConsigneeTable.Comments.Format(DC_ConsigneeTable.Comments.DefaultValue);
            }
            ...
            if (this.DataSource.CustomerIdSpecified) {
                ...
                this.CustomerId1.Text = formattedValue;
                        
            } else {  
                this.CustomerId1.Text = DC_ConsigneeTable.CustomerId.Format(DC_ConsigneeTable.CustomerId.DefaultValue);
            }
                    
            if (this.CustomerId1.Text == null ||
                this.CustomerId1.Text.Trim().Length == 0) {
                this.CustomerId1.Text = "&nbsp;";
            }
            ...
            if (this.DataSource.PhoneSpecified) {
                ...
                this.Phone1.Text = DC_ConsigneeTable.Phone.Format(DC_ConsigneeTable.Phone.DefaultValue);
            }
            ...
            if (this.DataSource.PhoneMobileSpecified) {
                ...
                this.PhoneMobile1.Text = formattedValue;
                        
            } else {  
                this.PhoneMobile1.Text = DC_ConsigneeTable.PhoneMobile.Format(DC_ConsigneeTable.PhoneMobile.DefaultValue);
            }
                    
            if (this.PhoneMobile1.Text == null ||
                this.PhoneMobile1.Text.Trim().Length == 0) {
                this.PhoneMobile1.Text = "&nbsp;";
            }
            ...
            if (this.DataSource.PostalCodeSpecified) {
                ...
                this.PostalCode1.Text = formattedValue;
                        
            } else {  
                this.PostalCode1.Text = DC_ConsigneeTable.PostalCode.Format(DC_ConsigneeTable.PostalCode.DefaultValue);
            }
                    
            if (this.PostalCode1.Text == null ||
                this.PostalCode1.Text.Trim().Length == 0) {
                this.PostalCode1.Text = "&nbsp;";
            }
            ...
            if (this.DataSource.StateProvinceSpecified) {
                ...
                this.StateProvince1.Text = formattedValue;
                        
            } else {  
                this.StateProvince1.Text = DC_ConsigneeTable.StateProvince.Format(DC_ConsigneeTable.StateProvince.DefaultValue);
            }
                    
            if (this.StateProvince1.Text == null ||
                this.StateProvince1.Text.Trim().Length == 0) {
                this.StateProvince1.Text = "&nbsp;";
            }
        ...
        public virtual void SaveData()
        {
            ...
            // DC_Customer in DC_CustomerRecordControl is One To Many to DC_ConsigneeTableControl.
                    
            // Setup the parent id in the record.
            DC_CustomerRecordControl recDC_CustomerRecordControl = (DC_CustomerRecordControl)this.Page.FindControlRecursively("DC_CustomerRecordControl");
            if (recDC_CustomerRecordControl != null && recDC_CustomerRecordControl.DataSource == null) {
                // Load the record if it is not loaded yet.
                recDC_CustomerRecordControl.LoadData();
            }
            if (recDC_CustomerRecordControl == null || recDC_CustomerRecordControl.DataSource == null) {
            ...
            this.DataSource.CustomerId = recDC_CustomerRecordControl.DataSource.CustomerId;
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.Literal City1 {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "City1");
            }
        }
        ...
        public System.Web.UI.WebControls.Literal CustomerId1 {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "CustomerId1");
            }
        }
        ...
        public System.Web.UI.WebControls.Literal PhoneMobile1 {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "PhoneMobile1");
            }
        }
           
        public System.Web.UI.WebControls.Literal PostalCode1 {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "PostalCode1");
            }
        }
           
        public System.Web.UI.WebControls.Literal StateProvince1 {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "StateProvince1");
            }
        }
...
// Base class for the DC_ConsigneeTableControl control on the ShowDC_CustomerPage page.
...
public class BaseDC_ConsigneeTableControl : ePortDC.UI.BaseApplicationTableControl
{
        ...
        protected virtual void Control_Init(object sender, System.EventArgs e)
        {
            ...
            // Setup the sorting events.
              ...
              this.CityLabel1.Click += new EventHandler(CityLabel1_Click);
            
              this.CommentsLabel1.Click += new EventHandler(CommentsLabel1_Click);
            
              this.ConsigneeIdLabel1.Click += new EventHandler(ConsigneeIdLabel1_Click);
            
              this.ConsigneeNameLabel.Click += new EventHandler(ConsigneeNameLabel_Click);
            
              this.CustomerId1Label.Click += new EventHandler(CustomerId1Label_Click);
            
              this.CustomsBrokerOfficeIdLabel1.Click += new EventHandler(CustomsBrokerOfficeIdLabel1_Click);
            
              this.PhoneLabel1.Click += new EventHandler(PhoneLabel1_Click);
            
              this.PhoneMobileLabel1.Click += new EventHandler(PhoneMobileLabel1_Click);
            
              this.PostalCodeLabel1.Click += new EventHandler(PostalCodeLabel1_Click);
            
              this.StateProvinceLabel1.Click += new EventHandler(StateProvinceLabel1_Click);
    ...
    // Setup default pagination settings.
        ...
        DC_CustomerRecordControl parentRecordControl = (DC_CustomerRecordControl)(this.Page.FindControlRecursively("DC_CustomerRecordControl"));
            DC_CustomerRecord parentRec = parentRecordControl.GetRecord();
            if (parentRec == null) {
                // Get the error message from the application resource file.
                throw new Exception(Page.GetResourceValue("Err:ParentNotInitialized", "ePortDC"));
            }
           
            if (parentRec.CustomerIdSpecified) {
                wc.iAND(DC_ConsigneeTable.CustomerId, BaseFilter.ComparisonOperator.EqualsTo, parentRec.CustomerId.ToString());
            } else {
                wc.RunQuery = false;
                return wc;
            }
        ...
        public virtual WhereClause CreateWhereClause(String searchText, String fromSearchControl, String AutoTypeAheadSearch, String AutoTypeAheadWordSeparators)
        {
            ...
            wc.iAND(DC_ConsigneeTable.CustomerId, BaseFilter.ComparisonOperator.EqualsTo, pkValue.GetColumnValue(DC_CustomerTable.CustomerId).ToString());
                
                } else {
              
            wc.iAND(DC_ConsigneeTable.CustomerId, BaseFilter.ComparisonOperator.EqualsTo, recId);
                ...
                foreach (System.Web.UI.WebControls.RepeaterItem repItem in rep.Items)
                {
                    ...
                    if (recControl.Visible && recControl.IsNewRecord) {
                        ...
                        if (recControl.Address1.Text != "") {
                            rec.Parse(recControl.Address1.Text, DC_ConsigneeTable.Address);
                        }
                        if (recControl.City1.Text != "") {
                            rec.Parse(recControl.City1.Text, DC_ConsigneeTable.City);
                        }
                        if (recControl.Comments1.Text != "") {
                            rec.Parse(recControl.Comments1.Text, DC_ConsigneeTable.Comments);
                        }
                        ...
                        if (recControl.CustomerId1.Text != "") {
                            rec.Parse(recControl.CustomerId1.Text, DC_ConsigneeTable.CustomerId);
                        }
                        ...
                        if (recControl.Phone1.Text != "") {
                            rec.Parse(recControl.Phone1.Text, DC_ConsigneeTable.Phone);
                        }
                        if (recControl.PhoneMobile1.Text != "") {
                            rec.Parse(recControl.PhoneMobile1.Text, DC_ConsigneeTable.PhoneMobile);
                        }
                        if (recControl.PostalCode1.Text != "") {
                            rec.Parse(recControl.PostalCode1.Text, DC_ConsigneeTable.PostalCode);
                        }
                        if (recControl.StateProvince1.Text != "") {
                            rec.Parse(recControl.StateProvince1.Text, DC_ConsigneeTable.StateProvince);
                        }
        ...
        // Generate the event handling functions for sorting events.
            ...
            this.DataChanged = true;
              ...
              // event handler for FieldSort
              public virtual void CityLabel1_Click(object sender, EventArgs args)
              {
            ...
            this.DataChanged = true;
              ...
              // event handler for FieldSort
              public virtual void CommentsLabel1_Click(object sender, EventArgs args)
              {
            ...
            this.DataChanged = true;
              ...
              // event handler for FieldSort
              public virtual void ConsigneeIdLabel1_Click(object sender, EventArgs args)
              {
            ...
            this.DataChanged = true;
              ...
              // event handler for FieldSort
              public virtual void CustomerId1Label_Click(object sender, EventArgs args)
              {
            ...
            this.DataChanged = true;
              ...
              // event handler for FieldSort
              public virtual void PhoneLabel1_Click(object sender, EventArgs args)
              {
            ...
            this.DataChanged = true;
              ...
              // event handler for FieldSort
              public virtual void PhoneMobileLabel1_Click(object sender, EventArgs args)
              {
            ...
            this.DataChanged = true;
              ...
              // event handler for FieldSort
              public virtual void PostalCodeLabel1_Click(object sender, EventArgs args)
              {
            ...
            this.DataChanged = true;
              ...
              // event handler for FieldSort
              public virtual void StateProvinceLabel1_Click(object sender, EventArgs args)
              {
        ...
        report.SpecificReportFileName = Page.Server.MapPath("ShowDC_CustomerPage.DC_ConsigneePDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "DC_Consignee";
                // If ShowDC_CustomerPage.DC_ConsigneePDFButton.report specifies a valid report template,
                    ...
                    if (records != null && records.Length > 0)
                    {
                        foreach ( DC_ConsigneeRecord record in records)
                        {
                            ...
                            // The 4th parameters represents the maximum length of the data value being shown
                             ...
                             report.AddData("${DC_ConsigneeTable.CustomerId.Name}", record.Format(DC_ConsigneeTable.CustomerId), ReportEnum.Align.Left, 100);
            ...
            ((DC_CustomerRecordControl)(this.Page.FindControlRecursively("DC_CustomerRecordControl"))).ResetData = true;
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.LinkButton CityLabel1 {
            get {
                return (System.Web.UI.WebControls.LinkButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "CityLabel1");
            }
        }
        
        public System.Web.UI.WebControls.LinkButton CommentsLabel1 {
            get {
                return (System.Web.UI.WebControls.LinkButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "CommentsLabel1");
            }
        }
        ...
        public System.Web.UI.WebControls.LinkButton ConsigneeIdLabel1 {
            get {
                return (System.Web.UI.WebControls.LinkButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "ConsigneeIdLabel1");
            }
        }
        ...
        public System.Web.UI.WebControls.LinkButton CustomerId1Label {
            get {
                return (System.Web.UI.WebControls.LinkButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "CustomerId1Label");
            }
        }
        
        public System.Web.UI.WebControls.Literal CustomerId2Label {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "CustomerId2Label");
            }
        }
        ...
        public System.Web.UI.WebControls.LinkButton PhoneLabel1 {
            get {
                return (System.Web.UI.WebControls.LinkButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "PhoneLabel1");
            }
        }
        
        public System.Web.UI.WebControls.LinkButton PhoneMobileLabel1 {
            get {
                return (System.Web.UI.WebControls.LinkButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "PhoneMobileLabel1");
            }
        }
        
        public System.Web.UI.WebControls.LinkButton PostalCodeLabel1 {
            get {
                return (System.Web.UI.WebControls.LinkButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "PostalCodeLabel1");
            }
        }
        ...
        public System.Web.UI.WebControls.LinkButton StateProvinceLabel1 {
            get {
                return (System.Web.UI.WebControls.LinkButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "StateProvinceLabel1");
            }
        }
...
#region "Helper Functions"
        ...
        public DC_ConsigneeTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (DC_ConsigneeTableControlRow[])(selectedList.ToArray(Type.GetType("ePortDC.UI.Controls.ShowDC_CustomerPage.DC_ConsigneeTableControlRow")));
        ...
        public DC_ConsigneeTableControlRow[] GetRecordControls()
        {
            ...
            return (DC_ConsigneeTableControlRow[])recList.ToArray(Type.GetType("ePortDC.UI.Controls.ShowDC_CustomerPage.DC_ConsigneeTableControlRow"));
        }
...
// Base class for the DC_CustomerRecordControl control on the ShowDC_CustomerPage page.
...
public class BaseDC_CustomerRecordControl : ePortDC.UI.BaseApplicationRecordControl
{
        ...
        protected virtual void Control_Init(object sender, System.EventArgs e)
        {
            // Register the event handlers.
              ...
              this.DC_CustomerDialogEditButton.Click += new ImageClickEventHandler(DC_CustomerDialogEditButton_Click);
        }
        ...
        protected override object SaveViewState()
        {
            ...
            return base.SaveViewState();
              ...
              // event handler for ImageButton
              public virtual void DC_CustomerDialogEditButton_Click(object sender, ImageClickEventArgs args)
              {
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.ImageButton DC_CustomerDialogEditButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "DC_CustomerDialogEditButton");
            }
        }
