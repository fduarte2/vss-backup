...
namespace ePortDC.UI.Controls.LargeListSelector
{
    ...
    public class BaseItemsTableRecordControl : ePortDC.UI.BaseApplicationRecordControl
    {
    ...
    public class BaseItemsTable : ePortDC.UI.BaseApplicationTableControl
    {
	...
	public virtual bool FormatSuggestions(string prefixText, string resultItem, int columnLength, string AutoTypeAheadDisplayFoundText, string autoTypeAheadSearch, string AutoTypeAheadWordSeparators, ArrayList resultList) 
	{
        ...
        public string Table
        {
			...
			return tableName; 
                ...
                try
                {
                    string tableType = string.Format(TYPE_FORMAT, "ePortDC.Business", tableName, "Table", "App_Code");
                ...
                try
                {
                    string viewType = string.Format(TYPE_FORMAT, "ePortDC.Business", tableName, "View", "App_Code");
                ...
                try
                {
                    string queryType = string.Format(TYPE_FORMAT, "ePortDC.Business", tableName, "Query", "App_Code");
        ...
        public ePortDC.UI.IThemeButton SearchButton
        {
            get
            {
                return ((ePortDC.UI.IThemeButton)(MiscUtils.FindControlRecursively(this, "SearchButton")));
            }
        }

        public ePortDC.UI.IPagination Pagination
        {
            get
            {
                return ((ePortDC.UI.IPagination)(MiscUtils.FindControlRecursively(this, "Pagination")));
            }
        }
        ...
        public ItemsTableRecordControl[] GetRecordControls()
        {
            ...
            return ((ItemsTableRecordControl[])(recList.ToArray(Type.GetType("ePortDC.UI.Controls.LargeListSelector.ItemsTableRecordControl"))));
        }
        ...
        public BaseClasses.Data.BaseTable GetTable()
        {
            ...
            {
                tn = string.Format("{0}.{1}Access,{2}", "ePortDC", tn.Replace(" ", "_"), "ePortDC");
                return BaseClasses.Data.BaseTable.CreateInstance(tn);
            }
        }
    }
