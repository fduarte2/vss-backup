...
namespace ePortDC
{
    public class FvLlsHyperLink : BaseClasses.Web.UI.WebControls.PopupWindowHyperLink
    {
        ...
        protected string DeriveNavigateUrl()
        {
            ...
            return string.Format("~/Shared/LargeListSelector.aspx?Table={0}&Field={1}&DisplayField={2}&Target={3}&usnh=n", HttpUtility.UrlEncode(tableName), HttpUtility.UrlEncode(fieldName), HttpUtility.UrlEncode(displayFieldName), HttpUtility.UrlEncode(c.ClientID));
        }
