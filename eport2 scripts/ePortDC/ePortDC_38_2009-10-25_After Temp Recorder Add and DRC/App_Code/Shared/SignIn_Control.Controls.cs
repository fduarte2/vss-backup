namespace ePortDC.UI.Controls.SignIn_Control
{
	...
	#region " Protected Properties"
			...
			protected string ERR_INVALID_LOGIN_INFO
			{
				get
				{
                    return ((BaseApplicationPage)(this.Page)).GetResourceValue("Err:InvalidLoginInfo", "ePortDC");
				}
			...
			protected string ERR_INTERNAL_ERROR
			{
				get
				{
                    return ((BaseApplicationPage)(this.Page)).GetResourceValue("Err:InternalErrorLogin", "ePortDC");
				}
			...
			protected string LOGIN_MSG
			{
				get
				{
                    return ((BaseApplicationPage)(this.Page)).GetResourceValue("Txt:LoginMsg", "ePortDC");
				}
			...
			protected string LOGIN_MSG_SESSION_INVALID
			{
				get
				{
                    return ((BaseApplicationPage)(this.Page)).GetResourceValue("Txt:LoginMsgSessionInvalid", "ePortDC");
				}
	...
	#region " Login Methods "
			...
			public virtual void Login(bool bRedirectOnSuccess)
			{
				...
				try
				{
					bSuccess = ((BaseApplicationPage)(this.Page)).SystemUtils.SetLoginInfo(strUserName, strPassword, ref errMessage);
				}
