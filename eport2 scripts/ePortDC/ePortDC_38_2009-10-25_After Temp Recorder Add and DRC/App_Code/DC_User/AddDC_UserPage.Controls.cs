...
// AddDC_UserPage.aspx page.  The Row or RecordControl classes are the 
...
namespace ePortDC.UI.Controls.AddDC_UserPage
{
...
// Base class for the DC_UserRecordControl control on the AddDC_UserPage page.
...
public class BaseDC_UserRecordControl : ePortDC.UI.BaseApplicationRecordControl
{
        ...
        public virtual void LoadData()  
        {
            ...
            if (recList.Length == 0) {
                throw new Exception(Page.GetResourceValue("Err:NoRecRetrieved", "ePortDC"));
                    ...
                    this.DataSource = (DC_UserRecord)DC_UserRecord.Copy(recList[0], false);
        ...
        public virtual void GetUIData()
        {
            ...
            foreach(BaseColumn col in DC_UserRecord.TableUtils.TableDefinition.Columns){
