...
// AddDC_CustomerPricePage.aspx page.  The Row or RecordControl classes are the 
...
namespace ePortDC.UI.Controls.AddDC_CustomerPricePage
{
...
// Base class for the DC_CustomerPriceRecordControl control on the AddDC_CustomerPricePage page.
...
public class BaseDC_CustomerPriceRecordControl : ePortDC.UI.BaseApplicationRecordControl
{
        ...
        public virtual void LoadData()  
        {
            ...
            if (recList.Length == 0) {
                throw new Exception(Page.GetResourceValue("Err:NoRecRetrieved", "ePortDC"));
                    ...
                    this.DataSource = (DC_CustomerPriceRecord)DC_CustomerPriceRecord.Copy(recList[0], false);
        ...
        public virtual void GetUIData()
        {
            ...
            foreach(BaseColumn col in DC_CustomerPriceRecord.TableUtils.TableDefinition.Columns){
...
#region "Helper Functions"
      ...
      if (rec == null && url.IndexOf("{") >= 0) {
        ...
        public DC_CustomerPriceRecord GetRecord()
        {
            ...
            return new DC_CustomerPriceRecord();
