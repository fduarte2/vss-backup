<%@ Register Tagprefix="ePortDC" Namespace="ePortDC.UI.Controls.AddDC_CustomerPricePage" %>
...
<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" CodeFile="AddDC_CustomerPricePage.aspx.cs" Inherits="ePortDC.UI.AddDC_CustomerPricePage" %>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <title>AddDC_CustomerPricePage</title>
...
<%= SystemUtils.GenerateEnterKeyCaptureBeginTag(FindControl("SaveNNewButton$_Button")) %>
 ...
 <table class="dialog_view" cellpadding="0" cellspacing="0" border="0">
    ...
    <tr>
    <td class="dhtr" valign="middle"><asp:Literal runat="server" id="DC_CustomerPriceDialogTitle" Text="Add Customer Price">
														</asp:Literal></td>
    </tr>
    </table>
    </td>	
