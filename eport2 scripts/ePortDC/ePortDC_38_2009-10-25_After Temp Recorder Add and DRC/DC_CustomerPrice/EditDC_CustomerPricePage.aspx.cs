...
// This file implements the code-behind class for EditDC_CustomerPricePage.aspx.
// App_Code\EditDC_CustomerPricePage.Controls.vb contains the Table, Row and Record control classes
...
partial class EditDC_CustomerPricePage
        : BaseApplicationPage
// Code-behind class for the EditDC_CustomerPricePage page.
...
#region "Section 1: Place your customizations here."    
        ...
        public EditDC_CustomerPricePage()
        {
            this.Initialize();
        }
    ...
    public void LoadData_Base()
    {
            ...
            try {
                ...
                if ((!this.IsPostBack)) {
                    ...
                    this.DC_CustomerPriceRecordControl.LoadData();
                    this.DC_CustomerPriceRecordControl.DataBind();           
          ...
          if (TargetKey != null){
            ...
            try {
                ...
                if (!this.IsPageRefresh) {
                    ...
                    this.DC_CustomerPriceRecordControl.SaveData();
