<%@ Register Tagprefix="ePortDC" Namespace="ePortDC.UI.Controls.ShowDC_CustomerPricePage" %>

<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" CodeFile="ShowDC_CustomerPricePage.aspx.cs" Inherits="ePortDC.UI.ShowDC_CustomerPricePage" %>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <title>ShowDC_CustomerPricePage</title>
            ...
            <tr>
                ...
                <td class="pcC">			
                    ...
                    <td>
                        ...
                        <tr>
                        <td class="pContent">
                            <a name="StartOfPageContent"></a><asp:UpdateProgress runat="server" id="DC_CustomerPriceRecordControlUpdateProgress" AssociatedUpdatePanelID="DC_CustomerPriceRecordControlUpdatePanel">
										<ProgressTemplate>
...
<%= SystemUtils.GenerateEnterKeyCaptureBeginTag(FindControl("EditButton$_Button")) %>
 <table class="dialog_view" cellpadding="0" cellspacing="0" border="0">
    ...
    <tr>
    <td class="dhtr" valign="middle"><asp:Literal runat="server" id="DC_CustomerPriceDialogTitle" Text="Show Customer Price">
														</asp:Literal></td>
    <td class="dhir"><asp:ImageButton runat="server" id="DC_CustomerPriceDialogEditButton" CausesValidation="False" CommandName="Redirect" Consumers="page" ImageURL="../Images/iconEdit.gif" RedirectURL="../DC_CustomerPrice/EditDC_CustomerPricePage.aspx?DC_CustomerPrice={PK}" ToolTip="&lt;%# GetResourceValue(&quot;Btn:Edit&quot;, &quot;ePortDC&quot;) %>" AlternateText="">
    ...
    <td class="dialog_field_value">
        <asp:LinkButton runat="server" id="CustomerId" CausesValidation="False" CommandName="Redirect" RedirectURL="../DC_Customer/ShowDC_CustomerPage.aspx?DC_Customer={DC_CustomerPriceRecordControl:FK:FK_DC_CustomerPrice_DC_Customer}">
														</asp:LinkButton>
    ...
    <td class="dialog_field_value">
        <asp:LinkButton runat="server" id="SizeId" CausesValidation="False" CommandName="Redirect" RedirectURL="../DC_CommoditySize/ShowDC_CommoditySizePage.aspx?DC_CommoditySize={DC_CustomerPriceRecordControl:FK:FK_DC_CustomerPrice_DC_CommoditySize}">
														</asp:LinkButton>
    ...
    <td class="dialog_field_value">
        <asp:Literal runat="server" id="EffectiveDate">
														</asp:Literal>
    ...
    <td class="dialog_field_value"><asp:Literal runat="server" id="Price">
														</asp:Literal></td>
    </tr>
    <tr>
