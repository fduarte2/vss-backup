<%@ Register Tagprefix="ePortDC" Namespace="ePortDC.UI.Controls.ShowDC_CommoditySizePage" %>

<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" CodeFile="ShowDC_CommoditySizePage.aspx.cs" Inherits="ePortDC.UI.ShowDC_CommoditySizePage" %>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <title>ShowDC_CommoditySizePage</title>
            ...
            <tr>
                ...
                <td class="pcC">			
                    ...
                    <td>
                        ...
                        <tr>
                        <td class="pContent">
                            <a name="StartOfPageContent"></a><asp:UpdateProgress runat="server" id="DC_CommoditySizeRecordControlUpdateProgress" AssociatedUpdatePanelID="DC_CommoditySizeRecordControlUpdatePanel">
										<ProgressTemplate>
...
<%= SystemUtils.GenerateEnterKeyCaptureBeginTag(FindControl("EditButton$_Button")) %>
 <table class="dialog_view" cellpadding="0" cellspacing="0" border="0">
    ...
    <tr>
    <td class="dhtr" valign="middle"><asp:Literal runat="server" id="DC_CommoditySizeDialogTitle" Text="Show Commodity Size">
														</asp:Literal></td>
    <td class="dhir"><asp:ImageButton runat="server" id="DC_CommoditySizeDialogEditButton" CausesValidation="False" CommandName="Redirect" Consumers="page" ImageURL="../Images/iconEdit.gif" RedirectURL="../DC_CommoditySize/EditDC_CommoditySizePage.aspx?DC_CommoditySize={PK}" ToolTip="&lt;%# GetResourceValue(&quot;Btn:Edit&quot;, &quot;ePortDC&quot;) %>" AlternateText="">
    ...
    <td class="dialog_field_value">
        <asp:Literal runat="server" id="SizeId">
														</asp:Literal>
    ...
    <td class="dialog_field_value">
        <asp:Literal runat="server" id="Descr">
														</asp:Literal>
    ...
    <td class="dialog_field_value">
        <asp:Literal runat="server" id="Price">
														</asp:Literal>
    ...
    <td class="dialog_field_value">
        <asp:Literal runat="server" id="SizeLow">
														</asp:Literal>
    ...
    <td class="dialog_field_value">
        <asp:Literal runat="server" id="SizeHigh">
														</asp:Literal>
    ...
    <td class="dialog_field_value">
        <asp:Literal runat="server" id="WeightKG">
														</asp:Literal>
...
<br/>
    ...
    <td><ePortDC:ThemeButton runat="server" id="EditButton" Button-CausesValidation="False" Button-CommandName="Redirect" Button-RedirectURL="../DC_CommoditySize/EditDC_CommoditySizePage.aspx?DC_CommoditySize={PK}" Button-Text="&lt;%# GetResourceValue(&quot;Btn:Edit&quot;, &quot;ePortDC&quot;) %>">
										</ePortDC:ThemeButton></td>
    <td><img src="../Images/space.gif" height="6" width="3" alt=""/></td>
    <td></td>
    <td><img src="../Images/space.gif" height="6" width="3" alt=""/></td>
