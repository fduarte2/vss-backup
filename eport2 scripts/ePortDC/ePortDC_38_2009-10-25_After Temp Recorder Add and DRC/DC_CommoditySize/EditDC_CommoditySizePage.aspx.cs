...
// This file implements the code-behind class for EditDC_CommoditySizePage.aspx.
// App_Code\EditDC_CommoditySizePage.Controls.vb contains the Table, Row and Record control classes
...
partial class EditDC_CommoditySizePage
        : BaseApplicationPage
// Code-behind class for the EditDC_CommoditySizePage page.
...
#region "Section 1: Place your customizations here."    
        ...
        public EditDC_CommoditySizePage()
        {
            this.Initialize();
        }
    ...
    public void LoadData_Base()
    {
            ...
            try {
                ...
                if ((!this.IsPostBack)) {
                    ...
                    this.DC_CommoditySizeRecordControl.LoadData();
                    this.DC_CommoditySizeRecordControl.DataBind();           
          ...
          if (TargetKey != null){
            ...
            try {
                ...
                if (!this.IsPageRefresh) {
                    ...
                    this.DC_CommoditySizeRecordControl.SaveData();
            ...
            if (this.DC_CommoditySizeRecordControl!= null && this.DC_CommoditySizeRecordControl.DataSource != null){
                id = this.DC_CommoditySizeRecordControl.DataSource.SizeId.ToString();
                value = this.DC_CommoditySizeRecordControl.DataSource.GetValue(this.DC_CommoditySizeRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(DFKA)).ToString();
                if(value == null){
                  value = id;
                }
