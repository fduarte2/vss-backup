<%@ Page Language="cs" AutoEventWireup="true" EnableEventValidation="false" CodeFile="LargeListSelector.aspx.cs" Inherits="ePortDC.UI.LargeListSelector" %>
<%@ Register Tagprefix="ePortDC" TagName="Pagination" Src="Pagination.ascx" %>

<%@ Register Tagprefix="Selectors" Namespace="ePortDC" %>

<%@ Register Tagprefix="ePortDC" Namespace="ePortDC.UI.Controls.LargeListSelector" %>

<%@ Register Tagprefix="BaseClasses" Namespace="BaseClasses.Web.UI.WebControls" Assembly="BaseClasses" %>
<%@ Register Tagprefix="ePortDC" TagName="ThemeButton" Src="ThemeButton.ascx" %>
...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body id="Body1" runat="server">
	<form id="Form1" method="post" runat="server">
		...
		<ContentTemplate>    
<ePortDC:ItemsTable runat="server" id="ItemsTable">
...
<table>
 <tr>
  ...
  <td style="vertical-align:middle;">
   <ePortDC:ThemeButton runat="server" id="SearchButton" Button-CausesValidation="False" Button-CommandName="Search" Button-Text="<%# GetResourceValue(&quot;Btn:SearchGoButtonText&quot;, &quot;ePortDC&quot;) %>">
			</ePortDC:ThemeButton>
  </td>
 </tr>
</table>
...
<table cellpadding="0" cellspacing="0" border="0">
 <tr>
  ...
  <td class="pagination_area" style="width:100%;">
	<ePortDC:Pagination runat="server" id="Pagination"></ePortDC:Pagination>
  </td>
...
<!-- END Pagination -->
		...
		<asp:Repeater runat="server" id="Row1">
					<ITEMTEMPLATE>
							<ePortDC:ItemsTableRecordControl runat="server" id="ItemsTableRecordControl">
			...
			<tr>
				...
				<td class="table_cell">
					<asp:Label runat="server" id="ItemText"></asp:Label>
							...
							</ePortDC:ItemsTableRecordControl>
					</ITEMTEMPLATE>
			</asp:Repeater>
	</table>
