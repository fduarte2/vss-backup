...
namespace ePortDC
{
    partial class ExportFieldValue : BaseClasses.Web.UI.BasePage
    {
        ...
        public string FieldId
        {
            get
            {
                return this.Request.Params["Field"];
            }
        }
        ...
        public string RecordId
        {
            get
            {
                return this.Request.Params["Record"];
            }
        }
        ...
        public string TableId
        {
            get
            {
                ...
                string tableName = ((string)this.Request.Params["Table"]).Replace(" ", "_");
                try
                {
