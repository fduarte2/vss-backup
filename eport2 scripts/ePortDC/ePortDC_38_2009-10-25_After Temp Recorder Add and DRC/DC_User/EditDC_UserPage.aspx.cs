...
// This file implements the code-behind class for EditDC_UserPage.aspx.
// App_Code\EditDC_UserPage.Controls.vb contains the Table, Row and Record control classes
...
partial class EditDC_UserPage
        : BaseApplicationPage
// Code-behind class for the EditDC_UserPage page.
    ...
    public void LoadData_Base()
    {
            ...
            try {
                ...
                if ((!this.IsPostBack)) {
                    ...
                    this.DC_UserRecordControl.LoadData();
                    this.DC_UserRecordControl.DataBind();           
          ...
          if (TargetKey != null){
            ...
            try {
                ...
                if (!this.IsPageRefresh) {
                    ...
                    this.DC_UserRecordControl.SaveData();
            ...
            if (this.DC_UserRecordControl!= null && this.DC_UserRecordControl.DataSource != null){
                id = this.DC_UserRecordControl.DataSource.UserId0.ToString();
                value = this.DC_UserRecordControl.DataSource.GetValue(this.DC_UserRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(DFKA)).ToString();
                if(value == null){
                  value = id;
                }
