...
// This file implements the code-behind class for ShowDC_UserTablePage.aspx.
// App_Code\ShowDC_UserTablePage.Controls.vb contains the Table, Row and Record control classes
...
partial class ShowDC_UserTablePage
        : BaseApplicationPage
// Code-behind class for the ShowDC_UserTablePage page.
    ...
    public void LoadData_Base()
    {
            ...
            try {
                ...
                if ((!this.IsPostBack)) {
                    ...
                    this.DC_UserTableControl.LoadData();
                    this.DC_UserTableControl.DataBind();           
