<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" CodeFile="ShowDC_UserPage.aspx.cs" Inherits="ePortDC.UI.ShowDC_UserPage" %>
<%@ Register Tagprefix="ePortDC" Namespace="ePortDC.UI.Controls.ShowDC_UserPage" %>
            ...
            <tr>
                ...
                <td class="pcC">			
                    ...
                    <td>
                        ...
                        <tr>
                        <td class="pContent">
                            <a name="StartOfPageContent"></a><asp:UpdateProgress runat="server" id="DC_UserRecordControlUpdateProgress" AssociatedUpdatePanelID="DC_UserRecordControlUpdatePanel">
										<ProgressTemplate>
...
<%= SystemUtils.GenerateEnterKeyCaptureBeginTag(FindControl("EditButton$_Button")) %>
 <table class="dialog_view" cellpadding="0" cellspacing="0" border="0">
    ...
    <tr>
    <td class="dhtr" valign="middle"><asp:Literal runat="server" id="DC_UserDialogTitle" Text="Show User">
														</asp:Literal></td>
    <td class="dhir"><asp:ImageButton runat="server" id="DC_UserDialogEditButton" CausesValidation="False" CommandName="Redirect" Consumers="page" ImageURL="../Images/iconEdit.gif" RedirectURL="../DC_User/EditDC_UserPage.aspx?DC_User={PK}" ToolTip="&lt;%# GetResourceValue(&quot;Btn:Edit&quot;, &quot;ePortDC&quot;) %>" AlternateText="">
    ...
    <td class="dialog_field_value">
        <asp:Literal runat="server" id="UserId1">
														</asp:Literal>
    ...
    <td class="dialog_field_value"><asp:Literal runat="server" id="Password">
														</asp:Literal></td>
    </tr>
    <tr>
    <td class="field_label_on_side"><asp:Literal runat="server" id="RoleLabel" Text="Role">
														</asp:Literal></td>
    <td class="dialog_field_value"><asp:Literal runat="server" id="Role">
														</asp:Literal></td>
    </tr>
    <tr>
    <td class="field_label_on_side"><asp:Literal runat="server" id="NameLabel" Text="Name">
														</asp:Literal></td>
    <td class="dialog_field_value"><asp:Literal runat="server" id="Name">
														</asp:Literal></td>
    </tr>
    <tr>
    <td class="field_label_on_side"><asp:Literal runat="server" id="EmailLabel" Text="Email">
														</asp:Literal></td>
    <td class="dialog_field_value"><asp:Literal runat="server" id="Email">
														</asp:Literal></td>
    </tr>
    <tr>
    ...
    <td class="dialog_field_value"><asp:Literal runat="server" id="Printer">
														</asp:Literal></td>
    </tr>
                </table>
    </td>
