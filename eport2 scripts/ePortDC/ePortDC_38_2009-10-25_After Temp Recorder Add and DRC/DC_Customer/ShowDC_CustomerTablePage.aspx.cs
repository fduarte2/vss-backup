...
// This file implements the code-behind class for ShowDC_CustomerTablePage.aspx.
// App_Code\ShowDC_CustomerTablePage.Controls.vb contains the Table, Row and Record control classes
...
partial class ShowDC_CustomerTablePage
        : BaseApplicationPage
// Code-behind class for the ShowDC_CustomerTablePage page.
...
#region "Section 1: Place your customizations here."    
        ...
        public ShowDC_CustomerTablePage()
        {
            this.Initialize();
        }
    ...
    public void LoadData_Base()
    {
            ...
            try {
                ...
                if ((!this.IsPostBack)) {
                    ...
                    this.DC_CustomerTableControl.LoadData();
                    this.DC_CustomerTableControl.DataBind();           
