...
// This file implements the code-behind class for EditDC_CustomerPage.aspx.
// App_Code\EditDC_CustomerPage.Controls.vb contains the Table, Row and Record control classes
...
partial class EditDC_CustomerPage
        : BaseApplicationPage
// Code-behind class for the EditDC_CustomerPage page.
    ...
    public void LoadData_Base()
    {
            ...
            try {
                ...
                if ((!this.IsPostBack)) {
                    ...
                    this.DC_CustomerRecordControl.LoadData();
                    this.DC_CustomerRecordControl.DataBind();           
          ...
          if (TargetKey != null){
            ...
            try {
                ...
                if (!this.IsPageRefresh) {
                    ...
                    this.DC_CustomerRecordControl.SaveData();
            ...
            if (this.DC_CustomerRecordControl!= null && this.DC_CustomerRecordControl.DataSource != null){
                id = this.DC_CustomerRecordControl.DataSource.CustomerId.ToString();
                value = this.DC_CustomerRecordControl.DataSource.GetValue(this.DC_CustomerRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(DFKA)).ToString();
                if(value == null){
                  value = id;
                }
