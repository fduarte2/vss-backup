...
<%@ Register Tagprefix="ePortDC" Namespace="ePortDC.UI.Controls.ShowDC_CustomerPage" %>
...
<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" CodeFile="ShowDC_CustomerPage.aspx.cs" Inherits="ePortDC.UI.ShowDC_CustomerPage" %>
<%@ Register Tagprefix="ePortDC" TagName="ThemeButton" Src="../Shared/ThemeButton.ascx" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head id="Head1" runat="server">
    <title>ShowDC_CustomerPage</title>
            ...
            <tr>
                ...
                <td class="pcC">			
                    ...
                    <td>
                        ...
                        <tr>
                        <td class="pContent">
                            <a name="StartOfPageContent"></a><asp:UpdateProgress runat="server" id="DC_CustomerRecordControlUpdateProgress" AssociatedUpdatePanelID="DC_CustomerRecordControlUpdatePanel">
										<ProgressTemplate>
...
<%= SystemUtils.GenerateEnterKeyCaptureBeginTag(FindControl("EditButton$_Button")) %>
 <table class="dialog_view" cellpadding="0" cellspacing="0" border="0">
    ...
    <tr>
    <td class="dhtr" valign="middle"><asp:Literal runat="server" id="DC_CustomerDialogTitle" Text="Show Customer">
														</asp:Literal></td>
    <td class="dhir"><asp:ImageButton runat="server" id="DC_CustomerDialogEditButton" CausesValidation="False" CommandName="Redirect" Consumers="page" ImageURL="../Images/iconEdit.gif" RedirectURL="../DC_Customer/EditDC_CustomerPage.aspx?DC_Customer={PK}" ToolTip="&lt;%# GetResourceValue(&quot;Btn:Edit&quot;, &quot;ePortDC&quot;) %>" AlternateText="">
    ...
    <td class="dialog_field_value">
        <asp:Literal runat="server" id="CustomerId">
														</asp:Literal>
    ...
    <td class="dialog_field_value"><asp:Literal runat="server" id="CustomerShortName">
														</asp:Literal></td>
    </tr>
    <tr>
    <td class="field_label_on_side"><asp:Literal runat="server" id="CustomerNameLabel" Text="Customer Name">
														</asp:Literal></td>
    <td class="dialog_field_value"><asp:Literal runat="server" id="CustomerName">
														</asp:Literal></td>
    </tr>
    <tr>
    ...
    <td class="dialog_field_value"><asp:Literal runat="server" id="NeedPARS">
														</asp:Literal></td>
    </tr>
    <tr>
    <td class="field_label_on_side"><asp:Literal runat="server" id="OriginLabel" Text="Origin">
														</asp:Literal></td>
    <td class="dialog_field_value"><asp:Literal runat="server" id="Origin">
														</asp:Literal></td>
    </tr>
    <tr>
    <td class="field_label_on_side"><asp:Literal runat="server" id="DestCodeLabel" Text="Destination Code">
														</asp:Literal></td>
    <td class="dialog_field_value"><asp:Literal runat="server" id="DestCode">
														</asp:Literal></td>
    </tr><tr>
...
<table class="dv" cellpadding="0" cellspacing="0" border="0">
 ...
 <tr>
    ...
    <tr>
        ...
        <td><asp:DropDownList runat="server" id="CustomsBrokerOfficeIdFilter" CssClass="Filter_Input" onkeypress="dropDownListTypeAhead(this,false)" AutoPostBack="True">
																						</asp:DropDownList></td>
    </tr>
    <tr>
        ...
        <td class="fila"><asp:Literal runat="server" id="CustomerId2Label" Text="Customer">
																						</asp:Literal></td>
    ...
    <td>
        ...
        <td class="tre">
            ...
            <th class="thc" scope="col"><asp:LinkButton runat="server" id="CustomerId1Label" Text="Customer" CausesValidation="False">
																						</asp:LinkButton></th>
            ...
            <th class="thc" scope="col"><asp:LinkButton runat="server" id="CityLabel1" Text="City" CausesValidation="False">
																						</asp:LinkButton>
                </th>
            
            <th class="thc" scope="col"><asp:LinkButton runat="server" id="StateProvinceLabel1" Text="State Province" CausesValidation="False">
																						</asp:LinkButton>
                </th>
            
            <th class="thc" scope="col"><asp:LinkButton runat="server" id="PostalCodeLabel1" Text="Postal Code" CausesValidation="False">
																						</asp:LinkButton>
                </th>
            ...
            <th class="thc" scope="col"><asp:LinkButton runat="server" id="PhoneMobileLabel1" Text="Phone Mobile" CausesValidation="False">
																						</asp:LinkButton>
                </th><th class="thc" scope="col"><asp:LinkButton runat="server" id="CommentsLabel1" Text="Comments" CausesValidation="False">
																						</asp:LinkButton>
                </th>
            </tr>
            </div>
            ...
            <td class="ttc" ><asp:Literal runat="server" id="CustomerId1">
																											</asp:Literal></td>
            <td class="ttc" ><asp:LinkButton runat="server" id="CustomsBrokerOfficeId" CausesValidation="False" CommandName="Redirect" RedirectURL="../DC_CustomsBrokerOffice/ShowDC_CustomsBrokerOfficePage.aspx?DC_CustomsBrokerOffice={DC_ConsigneeTableControlRow:FK:FK_DC_Consignee_DC_CustomsBrokerOffice}">
																											</asp:LinkButton>
            &nbsp;</td>
            <td class="ttc" ><asp:Literal runat="server" id="Address1">
																											</asp:Literal>
            </td>
            <td class="ttc" ><asp:Literal runat="server" id="City1">
																											</asp:Literal>
            </td>
            <td class="ttc" ><asp:Literal runat="server" id="StateProvince1">
																											</asp:Literal>
            </td>
            <td class="ttc" ><asp:Literal runat="server" id="PostalCode1">
																											</asp:Literal>
            </td>
            <td class="ttc" ><asp:Literal runat="server" id="Phone1">
																											</asp:Literal>
            </td>
            <td class="ttc" ><asp:Literal runat="server" id="PhoneMobile1">
																											</asp:Literal>
            </td><td class="ttc" ><asp:Literal runat="server" id="Comments1">
																											</asp:Literal>
            </td>
            </tr>
            </div>
