...
// This file implements the code-behind class for ShowDC_VesselTablePage.aspx.
// App_Code\ShowDC_VesselTablePage.Controls.vb contains the Table, Row and Record control classes
...
partial class ShowDC_VesselTablePage
        : BaseApplicationPage
// Code-behind class for the ShowDC_VesselTablePage page.
...
[System.Web.Services.WebMethod]
        public static string[] GetAutoCompletionList_DC_VesselSearchArea(String prefixText, int count)
        {
            // GetDC_VesselSearchAreaCompletionList gets the list of suggestions from the database.
            // prefixText is the search text typed by the user .
            // count specifies the number of suggestions to be returned.
            // Customize by adding code before or after the call to  GetAutoCompletionList_DC_VesselSearchArea_Base()
            // or replace the call to GetAutoCompletionList_DC_VesselSearchArea_Base().
            return GetAutoCompletionList_DC_VesselSearchArea_Base(prefixText, count);
        }
#endregion
...
#region "Section 2: Do not modify this section."
    ...
    public static string[] GetAutoCompletionList_DC_VesselSearchArea_Base(String prefixText, int count)
    {
        ...
        ePortDC.UI.Controls.ShowDC_VesselTablePage.DC_VesselTableControl control = new ePortDC.UI.Controls.ShowDC_VesselTablePage.DC_VesselTableControl();
        return control.GetAutoCompletionList_DC_VesselSearchArea(prefixText, count);
    }
    ...
    public void LoadData_Base()
    {
            ...
            try {
                ...
                if ((!this.IsPostBack)) {
                    ...
                    this.DC_VesselTableControl.LoadData();
                    this.DC_VesselTableControl.DataBind();           
