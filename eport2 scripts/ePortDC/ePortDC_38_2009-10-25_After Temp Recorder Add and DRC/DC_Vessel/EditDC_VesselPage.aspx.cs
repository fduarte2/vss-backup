...
// This file implements the code-behind class for EditDC_VesselPage.aspx.
// App_Code\EditDC_VesselPage.Controls.vb contains the Table, Row and Record control classes
...
partial class EditDC_VesselPage
        : BaseApplicationPage
// Code-behind class for the EditDC_VesselPage page.
          ...
          if (TargetKey != null){
            ...
            try {
                ...
                if (!this.IsPageRefresh) {
                    ...
                    this.DC_VesselRecordControl.SaveData();
            ...
            if (this.DC_VesselRecordControl!= null && this.DC_VesselRecordControl.DataSource != null){
                id = this.DC_VesselRecordControl.DataSource.VesselId.ToString();
                value = this.DC_VesselRecordControl.DataSource.GetValue(this.DC_VesselRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(DFKA)).ToString();
                if(value == null){
                  value = id;
                }
