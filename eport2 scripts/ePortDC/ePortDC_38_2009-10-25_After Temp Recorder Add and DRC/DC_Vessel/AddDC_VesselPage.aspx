...
<%@ Register Tagprefix="ePortDC" Namespace="ePortDC.UI.Controls.AddDC_VesselPage" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" CodeFile="AddDC_VesselPage.aspx.cs" Inherits="ePortDC.UI.AddDC_VesselPage" %>
...
<%= SystemUtils.GenerateEnterKeyCaptureBeginTag(FindControl("SaveNNewButton$_Button")) %>
 ...
 <table class="dialog_view" cellpadding="0" cellspacing="0" border="0">
    ...
    <tr>
    <td class="dhtr" valign="middle"><asp:Literal runat="server" id="DC_VesselDialogTitle" Text="Add Vessel">
														</asp:Literal></td>
    </tr>
    </table>
    </td>	
