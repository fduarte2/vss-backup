<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" CodeFile="ShowDC_VesselPage.aspx.cs" Inherits="ePortDC.UI.ShowDC_VesselPage" %>
<%@ Register Tagprefix="ePortDC" TagName="Footer" Src="../Header and Footer/Footer.ascx" %>

<%@ Register Tagprefix="ePortDC" Namespace="ePortDC.UI.Controls.ShowDC_VesselPage" %>
            ...
            <tr>
                ...
                <td class="pcC">			
                    ...
                    <td>
                        ...
                        <tr>
                        <td class="pContent">
                            <a name="StartOfPageContent"></a><asp:UpdateProgress runat="server" id="DC_VesselRecordControlUpdateProgress" AssociatedUpdatePanelID="DC_VesselRecordControlUpdatePanel">
										<ProgressTemplate>
...
<%= SystemUtils.GenerateEnterKeyCaptureBeginTag(FindControl("EditButton$_Button")) %>
 <table class="dialog_view" cellpadding="0" cellspacing="0" border="0">
    ...
    <tr>
    <td class="dhtr" valign="middle"><asp:Literal runat="server" id="DC_VesselDialogTitle" Text="Show Vessel">
														</asp:Literal></td>
    <td class="dhir"><asp:ImageButton runat="server" id="DC_VesselDialogEditButton" CausesValidation="False" CommandName="Redirect" Consumers="page" ImageURL="../Images/iconEdit.gif" RedirectURL="../DC_Vessel/EditDC_VesselPage.aspx?DC_Vessel={PK}" ToolTip="&lt;%# GetResourceValue(&quot;Btn:Edit&quot;, &quot;ePortDC&quot;) %>" AlternateText="">
    ...
    <td class="dialog_field_value">
        <asp:Literal runat="server" id="VesselId">
														</asp:Literal>
    ...
    <td class="dialog_field_value"><asp:Literal runat="server" id="VesselName">
														</asp:Literal></td>
    </tr>
    <tr>
    <td class="field_label_on_side"><asp:Literal runat="server" id="ArrivalDateLabel" Text="Arrival Date">
														</asp:Literal></td>
    <td class="dialog_field_value"><asp:Literal runat="server" id="ArrivalDate">
														</asp:Literal></td>
    </tr><tr>
    <td class="field_label_on_side"><asp:Literal runat="server" id="FixedFreightLabel" Text="Fixed Freight">
														</asp:Literal></td>
    <td class="dialog_field_value"><asp:Literal runat="server" id="FixedFreight">
														</asp:Literal></td>
    </tr>
                </table>
    </td>
