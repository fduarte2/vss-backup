if exists (select * from sysobjects where id = object_id(N'pePortDCDC_CustomsBrokerOfficeAdd') and sysstat & 0xf = 4) drop procedure pePortDCDC_CustomsBrokerOfficeAdd 
GO

-- Creates a new record in the [dbo].[DC_CustomsBrokerOffice] table.
CREATE PROCEDURE pePortDCDC_CustomsBrokerOfficeAdd
...
BEGIN
    INSERT
    INTO [dbo].[DC_CustomsBrokerOffice]
        (
