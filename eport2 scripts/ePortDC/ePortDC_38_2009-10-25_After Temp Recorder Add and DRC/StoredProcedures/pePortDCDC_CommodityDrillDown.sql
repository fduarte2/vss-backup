if exists (select * from sysobjects where id = object_id(N'pePortDCDC_CommodityDrillDown') and sysstat & 0xf = 4) drop procedure pePortDCDC_CommodityDrillDown 
GO

-- This stored procedure will return query result based on 
-- the passed in select, search and ORDER BY clauses.
CREATE PROCEDURE pePortDCDC_CommodityDrillDown
...
BEGIN
    ...
    BEGIN
        ...
        SET @l_createtemp_from = 
            ' FROM [dbo].[DC_Commodity] AS [DC_Commodity_], #IS_SECONDARY_TEMP_T_GETLIST'
