if exists (select * from sysobjects where id = object_id(N'pePortDCDC_ConsigneeDrillDown') and sysstat & 0xf = 4) drop procedure pePortDCDC_ConsigneeDrillDown 
GO

-- This stored procedure will return query result based on 
-- the passed in select, search and ORDER BY clauses.
CREATE PROCEDURE pePortDCDC_ConsigneeDrillDown
...
BEGIN
    ...
    BEGIN
        ...
        SET @l_createtemp_from = 
            ' FROM [dbo].[DC_Consignee] AS [DC_Consignee_], #IS_SECONDARY_TEMP_T_GETLIST'
