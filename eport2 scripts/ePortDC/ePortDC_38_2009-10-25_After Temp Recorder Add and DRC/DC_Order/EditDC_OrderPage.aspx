...
<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" CodeFile="EditDC_OrderPage.aspx.cs" Inherits="ePortDC.UI.EditDC_OrderPage" %>
...
<%@ Register Tagprefix="ePortDC" Namespace="ePortDC.UI.Controls.EditDC_OrderPage" %>
...
<asp:Label runat="server" id="VesselInfoLabel" Text="**">
...
<asp:Label runat="server" id="CustomerInfoLabel" Text="**">
    ...
    <td class="dialog_field_value"><asp:DropDownList runat="server" id="ConsigneeId" CssClass="field_input" onkeypress="dropDownListTypeAhead(this,false)">
														...
														<Selectors:FvLlsHyperLink runat="server" id="ConsigneeIdFvLlsHyperLink" ControlToUpdate="ConsigneeId" Text="&lt;%# GetResourceValue(&quot;LLS:Text&quot;, &quot;ePortDC&quot;) %>" Table="DC_Consignee" Field="DC_Consignee_.ConsigneeId" DisplayField="DC_Consignee_.ConsigneeName">														</Selectors:FvLlsHyperLink>&nbsp;
...
<asp:Label runat="server" id="ConsigneeInfoLabel" Text="**">
    ...
    <td class="dialog_field_value"><table border="0" cellpadding="0" cellspacing="0">
														...
														</td><td class="field_label_on_side"><asp:Label runat="server" id="CustomsBrokerLabel" Text="Customs Broker">
    ...
    <td class="dialog_field_value"><asp:Label runat="server" id="FixedFreightInfoLabel" Text="**">
														</asp:Label></td><td class="field_label_on_side"><asp:Literal runat="server" id="TotalCountLabel" Text="Total Carton Count">
														</asp:Literal></td><td class="dialog_field_value"><asp:Label runat="server" id="TotalCount" EnableIncrementDecrementButtons="True">
														</asp:Label></td>
    </tr>
    <tr>
    ...
    <td class="dialog_field_value"><asp:TextBox runat="server" id="DriverName" Columns="30" MaxLength="30" CssClass="field_input" EnableIncrementDecrementButtons="True">
														...
														<BaseClasses:TextBoxMaxLengthValidator runat="server" id="DriverNameTextBoxMaxLengthValidator" ControlToValidate="DriverName" ErrorMessage="&lt;%# GetResourceValue(&quot;Val:ValueTooLong&quot;, &quot;ePortDC&quot;).Replace(&quot;{FieldName}&quot;, &quot;Driver Name&quot;) %>">														</BaseClasses:TextBoxMaxLengthValidator></td><td class="field_label_on_side"><asp:Literal runat="server" id="TotalPalletCountLabel" Text="Total Pallet Count">
														</asp:Literal></td><td class="dialog_field_value"><asp:Label runat="server" id="TotalPalletCount" EnableIncrementDecrementButtons="True">
														</asp:Label></td>
    </tr>
    <tr>
    <td class="field_label_on_side"><asp:Literal runat="server" id="TrailerNumLabel" Text="Trailer Number">
														</asp:Literal></td>
    <td class="dialog_field_value"><asp:TextBox runat="server" id="TrailerNum" Columns="15" MaxLength="15" CssClass="field_input" EnableIncrementDecrementButtons="True">
														</asp:TextBox>&nbsp;
														<BaseClasses:TextBoxMaxLengthValidator runat="server" id="TrailerNumTextBoxMaxLengthValidator" ControlToValidate="TrailerNum" ErrorMessage="&lt;%# GetResourceValue(&quot;Val:ValueTooLong&quot;, &quot;ePortDC&quot;).Replace(&quot;{FieldName}&quot;, &quot;Trailer Number&quot;) %>">														</BaseClasses:TextBoxMaxLengthValidator></td><td class="field_label_on_side"><asp:Literal runat="server" id="TotalQuantityKGLabel" Text="Total Weight (KG)">
														</asp:Literal></td><td class="dialog_field_value"><asp:Label runat="server" id="TotalQuantityKG" EnableIncrementDecrementButtons="True">
														</asp:Label></td>
    </tr><tr>
    <td class="field_label_on_side"><asp:Literal runat="server" id="TruckTagLabel" Text="Truck Tag">
														</asp:Literal></td>
    <td class="dialog_field_value"><asp:TextBox runat="server" id="TruckTag" Columns="15" MaxLength="15" CssClass="field_input" EnableIncrementDecrementButtons="True">
														</asp:TextBox>&nbsp;
														<BaseClasses:TextBoxMaxLengthValidator runat="server" id="TruckTagTextBoxMaxLengthValidator" ControlToValidate="TruckTag" ErrorMessage="&lt;%# GetResourceValue(&quot;Val:ValueTooLong&quot;, &quot;ePortDC&quot;).Replace(&quot;{FieldName}&quot;, &quot;Truck Tag&quot;) %>">														</BaseClasses:TextBoxMaxLengthValidator></td><td class="field_label_on_side"><asp:Literal runat="server" id="TotalBoxDamagedLabel" Text="Total Box Damaged">
														</asp:Literal></td><td class="dialog_field_value"><asp:Label runat="server" id="TotalBoxDamaged" EnableIncrementDecrementButtons="True">
														</asp:Label></td>
    </tr><tr>
    <td class="field_label_on_side"><asp:Literal runat="server" id="SealNumLabel" Text="Seal Number">
														</asp:Literal></td>
    <td class="dialog_field_value"><asp:TextBox runat="server" id="SealNum" Columns="15" MaxLength="15" CssClass="field_input">
														</asp:TextBox>&nbsp;
														<BaseClasses:TextBoxMaxLengthValidator runat="server" id="SealNumTextBoxMaxLengthValidator" ControlToValidate="SealNum" ErrorMessage="&lt;%# GetResourceValue(&quot;Val:ValueTooLong&quot;, &quot;ePortDC&quot;).Replace(&quot;{FieldName}&quot;, &quot;Seal Number&quot;) %>">														</BaseClasses:TextBoxMaxLengthValidator></td><td class="field_label_on_side"><asp:Literal runat="server" id="TotalPriceLabel" Text="Total Price">
														</asp:Literal></td><td class="dialog_field_value"><asp:Label runat="server" id="TotalPrice">
														</asp:Label></td>
    </tr><tr>
    <td class="field_label_on_side"><asp:Literal runat="server" id="ZUser1Label" Text="BOL Comments">
														</asp:Literal></td>
    <td class="dialog_field_value"><asp:TextBox runat="server" id="ZUser1" Columns="50" MaxLength="50" CssClass="field_input">
														</asp:TextBox>&nbsp;
														<BaseClasses:TextBoxMaxLengthValidator runat="server" id="ZUser1TextBoxMaxLengthValidator" ControlToValidate="ZUser1" ErrorMessage="&lt;%# GetResourceValue(&quot;Val:ValueTooLong&quot;, &quot;ePortDC&quot;).Replace(&quot;{FieldName}&quot;, &quot;Z User 1&quot;) %>">														</BaseClasses:TextBoxMaxLengthValidator></td><td class="field_label_on_side">&nbsp;</td><td class="dialog_field_value"><ePortDC:ThemeButton runat="server" id="RefreshTotalsButton" Button-CausesValidation="True" Button-CommandName="Redirect" Button-RedirectURL="EditDC_OrderPage.aspx?DC_Order={DC_OrderRecordControl:PK}" Button-Text="Refresh Totals">
														</ePortDC:ThemeButton></td>
    </tr><tr>
    <td class="field_label_on_side"><asp:Literal runat="server" id="ZUser2Label" Text="Temp Recorder #">
														</asp:Literal></td>
    <td class="dialog_field_value"><asp:TextBox runat="server" id="ZUser2" Columns="50" MaxLength="50" CssClass="field_input">
														</asp:TextBox>&nbsp;
														<BaseClasses:TextBoxMaxLengthValidator runat="server" id="ZUser2TextBoxMaxLengthValidator" ControlToValidate="ZUser2" ErrorMessage="&lt;%# GetResourceValue(&quot;Val:ValueTooLong&quot;, &quot;ePortDC&quot;).Replace(&quot;{FieldName}&quot;, &quot;Z User 2&quot;) %>">														</BaseClasses:TextBoxMaxLengthValidator></td>
    <td class="field_label_on_side">&nbsp;</td>
    <td class="dialog_field_value"><asp:Image ImageUrl="../Images/SignatureNo.bmp" runat="server" id="SignatureImage" AlternateText="">

														</asp:Image></td>
    </tr><tr>
    <td class="field_label_on_side"><asp:Literal runat="server" id="CommentsCancelLabel" Text="Comments Cancel">
														</asp:Literal></td>
    <td class="dialog_field_value"><asp:TextBox runat="server" id="CommentsCancel" Columns="50" MaxLength="50" CssClass="field_input">
														</asp:TextBox>&nbsp;
														<BaseClasses:TextBoxMaxLengthValidator runat="server" id="CommentsCancelTextBoxMaxLengthValidator" ControlToValidate="CommentsCancel" ErrorMessage="&lt;%# GetResourceValue(&quot;Val:ValueTooLong&quot;, &quot;ePortDC&quot;).Replace(&quot;{FieldName}&quot;, &quot;Comments Cancel&quot;) %>">														</BaseClasses:TextBoxMaxLengthValidator></td>
    <td class="field_label_on_side">&nbsp;</td>
    <td class="dialog_field_value">&nbsp;</td>
    </tr>
		</table>&nbsp;</td>
    </tr>
    </table>
...
<table cellpadding="0" cellspacing="0" border="0" id="Table1">
    <tr>
    <td class="recordPanelButtonsAlignment"><table cellpadding="0" cellspacing="0" border="0">
    <tr>
    <td></td>
    <td><img src="../Images/space.gif" height="6" width="3" alt=""/></td>
    <td></td>
    <td><img src="../Images/space.gif" height="6" width="3" alt=""/></td>
    <td><ePortDC:ThemeButton runat="server" id="CancelButton" Button-CausesValidation="False" Button-CommandName="Redirect" Button-RedirectURL="ShowDC_OrderTablePage.aspx" Button-Text="Close">
																</ePortDC:ThemeButton></td><td>&nbsp;</td><td><ePortDC:ThemeButton runat="server" id="SaveButton" Button-CausesValidation="True" Button-CommandName="UpdateData" Button-RedirectURL="Back" Button-Text="&lt;%# GetResourceValue(&quot;Btn:Save&quot;, &quot;ePortDC&quot;) %>">
																</ePortDC:ThemeButton></td><td>&nbsp;</td><td><ePortDC:ThemeButton runat="server" id="SubmitButton" Button-CausesValidation="True" Button-CommandName="UpdateData" Button-RedirectURL="ShowDC_OrderTablePage.aspx" Button-Text="Submit">
																</ePortDC:ThemeButton></td>
    <td><img src="../Images/space.gif" height="6" width="3" alt=""/></td>
    <td><ePortDC:ThemeButton runat="server" id="SubmitRevisionButton" Button-CausesValidation="True" Button-CommandName="UpdateData" Button-RedirectURL="ShowDC_OrderTablePage.aspx" Button-Text="Submit Revision">
																</ePortDC:ThemeButton></td><td>&nbsp;</td><td><ePortDC:ThemeButton runat="server" id="SyncOrderButton" Button-CausesValidation="True" Button-CommandName="UpdateData" Button-Text="Sync Order">
																</ePortDC:ThemeButton></td>
    
	<td>&nbsp;</td><td><ePortDC:ThemeButton runat="server" id="SignPadButton" Button-CausesValidation="False" Button-CommandName="Redirect" Button-RedirectURL="http://eport2/Signature/sign.aspx?Vessel={DC_OrderRecordControl:NoUrlEncode:FDV:VesselId}&amp;OrderNum={DC_OrderRecordControl:NoUrlEncode:FV:OrderNum}" Button-Text="Sign Pad">
																</ePortDC:ThemeButton></td><td>&nbsp;</td><td><ePortDC:ThemeButton runat="server" id="PrintButton" Button-CausesValidation="False" Button-CommandName="Redirect" Button-RedirectURL="PrintDC_OrderPage.aspx?OrderNum={DC_OrderRecordControl:PK}" Button-Text="Print Order">
																</ePortDC:ThemeButton></td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td>
    <td><img src="../Images/space.gif" height="6" width="3" alt=""/></td>
    </tr><tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td><ePortDC:ThemeButton runat="server" id="CheckInDriverButton" Button-CausesValidation="True" Button-CommandName="UpdateData" Button-RedirectURL="ShowDC_OrderTablePage.aspx" Button-Text="Check-In Driver">
																</ePortDC:ThemeButton>
</td><td>&nbsp;</td><td><ePortDC:ThemeButton runat="server" id="StopLoadingButton" Button-CausesValidation="True" Button-CommandName="UpdateData" Button-RedirectURL="ShowDC_OrderTablePage.aspx" Button-Text="Stop Loading">
																</ePortDC:ThemeButton></td><td>&nbsp;</td><td><ePortDC:ThemeButton runat="server" id="TEReceivedButton" Button-CausesValidation="False" Button-CommandName="UpdateData" Button-RedirectURL="EditDC_OrderPage.aspx?DC_Order={DC_OrderRecordControl:PK}" Button-Text="TE Received">
																</ePortDC:ThemeButton>
</td>
    <td>&nbsp;</td>
    <td><ePortDC:ThemeButton runat="server" id="ConfirmOrderButton" Button-CausesValidation="True" Button-CommandName="UpdateData" Button-RedirectURL="EditDC_OrderPage.aspx?DC_Order={DC_OrderRecordControl:PK}" Button-Text="Confirm Order">
																</ePortDC:ThemeButton></td><td>&nbsp;</td><td><ePortDC:ThemeButton runat="server" id="PARSFormButton" Button-CausesValidation="False" Button-CommandName="Redirect" Button-RedirectURL="PARSDC_OrderPage.aspx?OrderNum={DC_OrderRecordControl:FV:OrderNum}" Button-Text="PARS Form">
																</ePortDC:ThemeButton>
</td>
    
	<td>&nbsp;</td><td><ePortDC:ThemeButton runat="server" id="SignatureCompleteButton" Button-CausesValidation="True" Button-CommandName="UpdateData" Button-RedirectURL="ShowDC_OrderTablePage.aspx" Button-Text="Signature Complete">
																</ePortDC:ThemeButton>
</td><td>&nbsp;</td><td><ePortDC:ThemeButton runat="server" id="CancelOrderButton" Button-CausesValidation="False" Button-CommandName="Redirect" Button-RedirectURL="CancelDC_OrderPage.aspx?OrderNum={DC_OrderRecordControl:PK}" Button-Text="Cancel Order">
																</ePortDC:ThemeButton></td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td>
    <td>&nbsp;</td>
    </tr>
    <tr>
    </tr></table></td>
            ...
            <tr>
                <td class="pcBL">&nbsp;</td>
                <td class="pcB"><ePortDC:Footer runat="server" id="PageFooter">
															</ePortDC:Footer></td>
                <td class="pcBR"></td>
            </tr>
            </table>
