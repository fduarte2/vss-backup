...
// This file implements the code-behind class for PickListDC_OrderPage.aspx.
// App_Code\PickListDC_OrderPage.Controls.vb contains the Table, Row and Record control classes
...
partial class PickListDC_OrderPage
        : BaseApplicationPage
// Code-behind class for the PickListDC_OrderPage page.
...
#region "Section 1: Place your customizations here."    
        ...
        public void LoadData()
        {
			...
			PicklistCompleteButton.Visible = false;
	        if ( (this.OrderStatusId.Text == "2 - SUBMITTED") || (this.OrderStatusId.Text == "3 - PICKLIST COMPLETE") )
	        {
				SaveButton.Visible = true;
	        	PicklistCompleteButton.Visible = true;
	        }
        }

        public void PicklistCompleteButton_Click(object sender, EventArgs args)
        {
        	// Pass which button got clicked into control class
			SystemUtils.SetDataAccessSettingsParameterValue("ButtonClicked", "PicklistCompleteButton");        
			
        	PicklistCompleteButton_Click_Base(sender, args);
        }
...
#region "Section 2: Do not modify this section."
        ...
        protected virtual void Page_InitializeEventHandlers(object sender, System.EventArgs e)
        {
            // Register the Event handler for any Events.
              ...
              this.PicklistCompleteButton.Button.Click += new EventHandler(PicklistCompleteButton_Click);
    ...
    public void LoadData_Base()
    {
            ...
            try {
                ...
                if ((!this.IsPostBack)) {
                    ...
                    this.DC_PickListTableControl.LoadData();
                    this.DC_PickListTableControl.DataBind();           
        ...
        // Write out event methods for the page events
          ...
          if (TargetKey != null){
            ...
            this.CloseWindow(true);
              ...
              // event handler for Button with Layout
              public void PicklistCompleteButton_Click_Base(object sender, EventArgs args)
              {
            ...
            try {
                ...
                if (!this.IsPageRefresh) {
                    ...
                    this.DC_PickListTableControl.SaveData();
