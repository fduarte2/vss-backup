<%@ Register Tagprefix="ePortDC" Namespace="ePortDC.UI.Controls.ShowDC_CommodityPage" %>

<%@ Register Tagprefix="ePortDC" TagName="Footer" Src="../Header and Footer/Footer.ascx" %>

<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" CodeFile="ShowDC_CommodityPage.aspx.cs" Inherits="ePortDC.UI.ShowDC_CommodityPage" %>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <title>ShowDC_CommodityPage</title>
            ...
            <tr>
                ...
                <td class="pcC">			
                    ...
                    <td>
                        ...
                        <tr>
                        <td class="pContent">
                            <a name="StartOfPageContent"></a><asp:UpdateProgress runat="server" id="DC_CommodityRecordControlUpdateProgress" AssociatedUpdatePanelID="DC_CommodityRecordControlUpdatePanel">
										<ProgressTemplate>
...
<%= SystemUtils.GenerateEnterKeyCaptureBeginTag(FindControl("EditButton$_Button")) %>
 <table class="dialog_view" cellpadding="0" cellspacing="0" border="0">
    ...
    <tr>
    <td class="dhtr" valign="middle"><asp:Literal runat="server" id="DC_CommodityDialogTitle" Text="Show Commodity">
														</asp:Literal></td>
    <td class="dhir"><asp:ImageButton runat="server" id="DC_CommodityDialogEditButton" CausesValidation="False" CommandName="Redirect" Consumers="page" ImageURL="../Images/iconEdit.gif" RedirectURL="../DC_Commodity/EditDC_CommodityPage.aspx?DC_Commodity={PK}" ToolTip="&lt;%# GetResourceValue(&quot;Btn:Edit&quot;, &quot;ePortDC&quot;) %>" AlternateText="">
    ...
    <td class="dialog_field_value">
        <asp:Literal runat="server" id="CommodityName">
														</asp:Literal>
    ...
    <td class="dialog_field_value">
        <asp:Literal runat="server" id="HarmonizedSystemTariff">
														</asp:Literal>
