...
// This file implements the code-behind class for EditDC_CommodityPage.aspx.
// App_Code\EditDC_CommodityPage.Controls.vb contains the Table, Row and Record control classes
...
partial class EditDC_CommodityPage
        : BaseApplicationPage
// Code-behind class for the EditDC_CommodityPage page.
    ...
    public void LoadData_Base()
    {
            ...
            try {
                ...
                if ((!this.IsPostBack)) {
                    ...
                    this.DC_CommodityRecordControl.LoadData();
                    this.DC_CommodityRecordControl.DataBind();           
          ...
          if (TargetKey != null){
            ...
            try {
                ...
                if (!this.IsPageRefresh) {
                    ...
                    this.DC_CommodityRecordControl.SaveData();
            ...
            if (this.DC_CommodityRecordControl!= null && this.DC_CommodityRecordControl.DataSource != null){
                id = this.DC_CommodityRecordControl.DataSource.CommodityCode.ToString();
                value = this.DC_CommodityRecordControl.DataSource.GetValue(this.DC_CommodityRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(DFKA)).ToString();
                if(value == null){
                  value = id;
                }
