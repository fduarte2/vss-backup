<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" CodeFile="AddDC_CustomsBrokerOfficePage.aspx.cs" Inherits="ePortDC.UI.AddDC_CustomsBrokerOfficePage" %>
...
<%@ Register Tagprefix="ePortDC" Namespace="ePortDC.UI.Controls.AddDC_CustomsBrokerOfficePage" %>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <title>AddDC_CustomsBrokerOfficePage</title>
...
<%= SystemUtils.GenerateEnterKeyCaptureBeginTag(FindControl("SaveNNewButton$_Button")) %>
 ...
 <table class="dialog_view" cellpadding="0" cellspacing="0" border="0">
    ...
    <tr>
    <td class="dhtr" valign="middle"><asp:Literal runat="server" id="DC_CustomsBrokerOfficeDialogTitle" Text="Add Customs Broker Office">
														</asp:Literal></td>
    </tr>
    </table>
    </td>	
