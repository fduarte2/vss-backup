...
// This file implements the code-behind class for EditDC_CustomsBrokerOfficePage.aspx.
// App_Code\EditDC_CustomsBrokerOfficePage.Controls.vb contains the Table, Row and Record control classes
...
partial class EditDC_CustomsBrokerOfficePage
        : BaseApplicationPage
// Code-behind class for the EditDC_CustomsBrokerOfficePage page.
...
#region "Section 1: Place your customizations here."    
        ...
        public EditDC_CustomsBrokerOfficePage()
        {
            this.Initialize();
        }
    ...
    public void LoadData_Base()
    {
            ...
            try {
                ...
                if ((!this.IsPostBack)) {
                    ...
                    this.DC_CustomsBrokerOfficeRecordControl.LoadData();
                    this.DC_CustomsBrokerOfficeRecordControl.DataBind();           
          ...
          if (TargetKey != null){
            ...
            try {
                ...
                if (!this.IsPageRefresh) {
                    ...
                    this.DC_CustomsBrokerOfficeRecordControl.SaveData();
            ...
            if (this.DC_CustomsBrokerOfficeRecordControl!= null && this.DC_CustomsBrokerOfficeRecordControl.DataSource != null){
                id = this.DC_CustomsBrokerOfficeRecordControl.DataSource.CustomsBrokerOfficeId.ToString();
                value = this.DC_CustomsBrokerOfficeRecordControl.DataSource.GetValue(this.DC_CustomsBrokerOfficeRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(DFKA)).ToString();
                if(value == null){
                  value = id;
                }
